...
## 2026-07-13 台榮／大魯閣排除避雷名單

- 使用者明確要求：`台榮`、`大魯閣` 是拿來領股利的持股，不要列在避雷／避買名單中。
- 本次處理：刪除既有 `taroko-sankong-hsieh-family`（大魯閣實業 / Taroko Sports / 遊戲愛樂園）record；全庫掃描未找到台榮既有 record，因此無需刪除台榮。
- 後續口徑：除非使用者重新明確要求，避免因政治人物／家族企業關聯把台榮或大魯閣加入 brand-avoidance-query。
