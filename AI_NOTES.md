...
- Records:
  - `foodnext-cunext-tong-yi-chan-food-education-city-personal`（歷史 ID 保留；searchable fields 僅《食力 foodNEXT》）
  - `foodnext-2026-food-education-city-partners-personal`
- KI 檢索：Pinecone `hermes-hudui` 的 `ai-notes` / `default` 預查與本機 source records 查重，未發現食力或2026食育力城市合作單位的既有直接紀錄。
- 《食力》2026-07-22 官方文章明載食育力城市大調查由《食力》發起，並逐一列出7個「合作單位／共創夥伴」：中華民國營養師公會全國聯合會、全國家長會長聯盟、國教行動聯盟、荒野保護協會、康善基金會、台灣兒童食育協會、食農教育點子膠囊。使用者要求「主辦方全部」加入，資料庫以一筆發起方紀錄加一筆7單位合作群組實作。
- 官方資料顯示宜蘭、嘉義、桃園、台中、新北共5個五星城市；台中為首度五星、六都中表現亮眼，不是全台唯一五星或全台單獨第一。
- 獨立審查退回原先把厚策思維、童儀展及不在2026合作名單內的灃食做成獨立搜尋目標之擴張做法；現已移除這些 searchable targets，並刪除灃食 record。社群圖卡只保留為使用者提出避開的線索，不能證明控制、贊助或油案責任。
- 最高法院2022-07-29新聞稿的油案責任只歸於頂新製油及判決所列被告，不可外溢成《食力》或7個合作單位共同製造劣油、共犯、受頂新控制、受其贊助或負法律責任。
- 兩筆皆採 `status: personal`、`confidence: high`；高信心只表示發起／合作角色及使用者指示可直接核對，不代表與油案有司法關係。
- 查詢設計：發起方僅保留《食力 foodNEXT》名稱與 `foodnext.net`；合作群組僅保留7個正式單位名稱。不要把厚策思維、童儀展、灃食、頂新、味全、食育力、五星城市、毒油、食安、主辦方、合作單位、基金會或協會等人物／關係／原因／泛稱作 alias 或 identifier。
