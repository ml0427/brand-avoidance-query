...
- Record：`hengju-construction-future-city-bus-ad-personal-20260822`；`personal` / `medium`。使用者提供屏東客運公車車身廣告照片並明確表示「放裸女打廣告有夠噁心，恆聚建設」，因此將使用者所指的恆聚建設／恆聚未來城行銷品牌列入個人避雷；理由是使用近似裸身女性圖像宣傳建案所引發的價值反感，不延伸成違法、色情、歧視或其他法律定性。
...
- 名為「恆聚建設」、handle `@恆聚建設` 的 YouTube 公開頻道列有「未來城-榮耀完工」及「恆聚-未來城」影片，支持品牌與建案的公開行銷關聯；但頻道不是法律登記證明。591 的「恆聚未來城」建案頁另將「建設」欄列為居德營建事業股份有限公司，因此本筆不把居德營建、屏東客運、模特兒、未知代銷／廣告代理商或其他同名公司納入使用者避雷。
- Searchable fields 僅 `恆聚建設`、`恆聚未來城`、簡體變體及必要 YouTube 頻道 ID；`未來城`、裸女、裸身、遮胸、性化、物化、噁心、廣告、公車、屏東客運、居德營建、內埔、榮耀完工、非華廈、3 房、送全戶裝潢、電話、YouTube 等理由／文案／平台／泛稱不得另作 standalone alias／identifier。證據檔：`evidence/user-submissions/2026-08-22-hengju-future-city-bus-ad.png`；SHA-256 `666a6d34a2ab1b8b2683a97272a1183886fbead0d0c91f49d603f8933e4e0ab8`。
