...
- 證據與範圍：使用者本次未指定特定言論、事件、政治立場或不當行為，因此紀錄只承接使用者對沈富雄本人的個人避雷，不自行補寫理由，也不外溢家屬、政黨、立法院、媒體節目、主持人、來賓或合作單位。搜尋欄位只保留姓名「沈富雄」。

## 2026-09-24｜撈王：中國火鍋業牛奶鮮鴨血調製法列為個人避雷理由

- 更新 `laowang-hotpot-shanghai-china-brand-personal-20260923`。撈王公開六道工序包含打散鮮鴨血、加水、加入牛奶、再次均質、靜置排泡成型及煮食；北京商報 2021 年報導中國火鍋市場「牛奶鴨血」走紅，並記載部分商戶現場混合鮮鴨血與牛奶。使用者明確表示「這套牛奶鴨血是中國火鍋業的調製工法，這就值得避雷」，因此把該工法納入既有撈王全品牌 `personal` 避雷理由。
- 證據邊界：個人避雷不以違法或主管機關認定為門檻；但現有資料只支持撈王公開工序與中國火鍋市場牛奶鮮鴨血品類的核心概念重疊，不代表與任一中國商品的完整配方、比例、添加物或殺菌控制完全相同。不得寫成已證實使用血粉、人工色素、非鴨血原料、違法添加物或食品不安全。
...
- 關係口徑：104 阿爾法餐飲公司頁直接刊載雞湯大叔、雞湯桑、麵屋一燈及賴山嶼職缺；TALKace 專訪把五品牌列入阿爾法多品牌營運脈絡。麵屋一燈是日本品牌，阿爾法自 2022 年接手台灣營運，2026 年取得除既有特定市場外的全球專屬授權，不得寫成阿爾法完整持有日本母品牌；賴山嶼由公開資料直接稱為阿爾法推出／打造品牌。
- 證據邊界：使用者的「撈王用中國假鴨血」仍是個人／貼文主張，沒有原料標示、供應商、進口紀錄或檢驗報告，不得升格為已證實食安事實，也不得外溢成其餘四品牌共用鴨血、共用全部食材、食安不合格或違法。四張新卡的充分理由是使用者明確依品牌營運／授權關聯選擇全品牌避雷。
- 去識別證據：`evidence/user-submissions/2026-09-24-alpha-dining-five-brands-user-directed-thread.png`，1250×970 RGBA；保留完整關係文字與五品牌名稱，排除帳號、頭像、裝置介面、趨勢列、留言、互動數與回覆框，metadata 僅 ICC profile。SHA-256：`6d58435c593ad3bef45f9531ee811a8b343c81c2641e2236d8d2f88305fb367b`；pixel SHA-256：`a91c4b180d2171e77d90f78c087cec28e76e761caf7393a9b7792e62913db7cc`。

## 2026-09-23｜撈王鍋物料理：中國上海餐飲品牌全品牌個人避雷

- 新增 `laowang-hotpot-shanghai-china-brand-personal-20260923`；`personal` / `high`。使用者提供 Threads 截圖後明確指定避雷。104 公開公司頁稱撈王鍋物料理於 2010 年在上海成立、門店遍布中國／香港／台灣；撈王信義店 LINE 官方帳號列北京、上海、蘇州、杭州等中國城市百餘家門店與「中國十大火鍋品牌」自述；TVBS 2017 年具名報導直接稱其為大陸知名連鎖火鍋、老闆是台灣人並在上海／江蘇／北京等地開店。依使用者既定的中國食品／餐飲品牌避買原則，撈王採全品牌個人避雷；這是中國上海成立與中國市場品牌背景判斷，不得擴寫成老闆是中國人、中國國資／政府控制，亦不表示台灣門市餐點或食材均在中國製造。
- 截圖轉貼文字稱「從中國來的色素鴨血」，但畫面只有食物顏色，沒有原料標示、供應商、進口紀錄或檢驗報告；不得寫成人工色素、中國鴨血／中國色素、化工鴨血、重金屬、食安不合格、違法或主管機關認定。聯合新聞網只用於把截圖的統一時代百貨台北、手搗肉滑／炙燒肉品文案橋接到撈王品牌。先前未指名撈王的一般鴨血抽驗與本案沒有品牌關聯，已撤回且不得再用來支持或反駁撈王。
- 去識別證據：`evidence/user-submissions/2026-09-23-laowang-china-brand-duck-blood-claim-thread.png`，1230×1080 RGBA；保留完整轉貼主張、`67foodie`、撈王及統一時代菜單文字與食物畫面，裁除手機狀態列、主貼帳號／頭像、其他留言、回覆輸入列，並以不透明遮罩移除左側殘留相對時間、追蹤按鈕及無關餐點畫面；metadata 僅 ICC profile。SHA-256：`3fff22e7fffbc7825239e3b3dd36f52f45b7685281a2e635bba20f8834b106a6`；pixel SHA-256：`c6b889349e472c4d0805fdd2b2fc01fe71cbaa7f73d48ea742ed898440f1ead1`。
...
- 新增 `chen-jiawei-uniform-pressure-remarks-personal-20260918`：TVBS 直接具名制服事件當事家長為陳嘉偉、皮膚科醫師；臺灣皮膚科醫學會專科檔案與高雄市醫師公會頁面支持其現任陳嘉偉皮膚科診所、兼任健仁醫院皮膚科支援醫師。記錄群組中的「施壓」原文、其後致歉，以及黃柏霖否認介入／施壓的邊界；不把診所、醫院、學校、議員或其他人列入避雷。
- 新增 `hsiao-yunrong-judge-user-directed-personal-20260918`：屏東地院官方法官事務分配支持蕭筠蓉現為刑四庭法官；避雷理由僅為使用者明確指定。沒有可靠公開來源證明她與陳嘉偉的配偶／親屬關係，也沒有證據顯示她參與制服事件或施壓，因此不得將這些內容寫成事實。
- 證據最小化：陳嘉偉圖只保留本人姓名與發言；蕭筠蓉圖只保留姓名、法官身分、現任法院及任期。第三張 Facebook 圖未入庫，避免保留人像與婚姻欄位。兩張圖均移除其他家長、班級、裝置介面及無關個資。
- 搜尋欄只保留兩人的本名；未加入「醫師」「皮膚科」「法官」或任職機構等別名，避免 substring 查詢污染。目標驗證 2 個正向、15 個反向案例通過；完整 validator 0 warnings／0 errors，Node tests 14/14。

此檔保存品牌避雷專案的耐久工作流記憶。未來處理本專案時，優先讀本檔與 `AGENTS.md`；全域 memory 只保留索引，不保存本專案細節。

## 2026-09-17 台灣護樹團體聯盟貼文列名：9 個團體個人避雷補齊

- 使用者提供「台灣護樹團體聯盟」社群貼文截圖並明確表示「這些團體都避雷」。畫面依序列出樹人會、撫遠公園護樹聯盟、城裡要有樹、筑樹小丘護樹工作室、城南老樹巡守隊、淡水公七公園自救會、環境法律人協會、雙和護樹聯盟、青潭國小老麵包樹守護隊，並概括這些民間團體持續守護在地老樹。既有卡已涵蓋台灣樹人會、撫遠公園護樹聯盟、筑樹小丘護樹工作室、城南老樹巡守隊；本次只新增其餘 5 張獨立 `personal` / `low` 團體卡，不建立重複卡。
- 來源只支持台灣護樹團體聯盟帳號曾如此列名及使用者的個人避雷授權；沒有個別負面事件、團體共同聲明、固定隸屬、成員名冊或法律責任資料。不得推定使用者反對護樹、老樹保存、公園保存、都市開發、地方自治、環境法律倡議或任何政治立場，也不外溢成員、志工、學生、家長、法律人、合作對象或所有環境倡議者。
- Sanitized evidence：`evidence/user-submissions/2026-09-17-taiwan-tree-groups-local-old-tree-post.png`，由 1290×2796 原圖裁成 1290×698 RGBA；保留發文帳號、可見日期時間、標題、9 個名稱與完整正文，遮除頭像及選單，排除裝置介面、互動數與留言區；metadata 只保留 ICC profile。SHA-256：`67c2c3b364162603b93cc2b2c1c0a06750a8652f53f957b6711357a933d8e14e`；pixel SHA-256：`7e7fb6561a87005761ae86f417aa761e642c1a83ed1bd5ee52af3f7698064705`。
- 驗證：重生後 329 筆 risk records／總數 335；9 個團體名稱逐筆正向查詢均命中各自唯一預期卡，source/generated parity 9/9。完整 validator 10 checks、5 筆新卡與 4 筆既有卡 target validator 均 `warnings: 0; errors: 0`；Node tests 14/14、syntax checks 20/20、`git diff --check` 通過。`brands.json` 重生前後 SHA-256 均為 `f22a24f09a39bc82db134e69883479976f7c8d6457dbb455823ac6262a813a63`，冪等通過。
...
- 範圍只限原帖具名的台北六張犁店家，不建立老闆、親屬、刑事警察人員、發文者或留言者紀錄。一次一般搜尋及一次替代搜尋均未取得可可靠重現的店家第一方頁面，依快速版硬閘門停止，不補官方帳號、地址、公司名或經營者姓名，也不追查其他貼文、案件或新聞支線。Searchable fields 只由 canonical name「茶山小（台北六張犁）」及 alias「茶山小」構成；台北／六張犁是 canonical name 內必要的同名範圍辨識，亂停車、霸占、報復、提告、和解、恐嚇、刑事局、大隊長、飲料店、Threads 與 `miho.lai` 均不作 alias／identifier；`country` 留空。
- Sanitized evidence：`evidence/user-submissions/2026-09-15-cha-shan-xiao-liuzhangli-parking-claims-thread.png`，由 1290×2796 RGBA 原圖依座標 `[20,380,1270,840]` 裁成 1250×460，並在輸出座標 `[0,0,170,160]` 以不透明深色遮罩移除頭像；完整保留發文帳號、主題、相對「13 小時」與正文，排除手機狀態列、導覽、新聞影像／人物、QR code、互動數、留言者及回覆列。metadata 僅保留 ICC profile；SHA-256：`0bcde001b0976b84388e274957d2141d5f18fb6cc09fc23f5c208c5167b42fde`；pixel SHA-256：`19702670bc326dbdb2eb771522fcbf25affed6ed712faeec0701a97914c05618`。
...
- 司法院裁判書直接橋接索爾斯科技股份有限公司／索爾斯科技有限公司與法定代理人陳宜謙；苗栗地院 113 司聲 114 直接使用「索爾斯科技股份有限公司即索爾斯科技有限公司」。公司全名查詢於 2026-09-14 回傳 15 份文件，但含同案判決、更正、二審、律師費、移送與補正，不能說成 15 次敗訴。可精確列入的核心為：新竹地院 113 訴 340 判返還程式合作終止款 93.6 萬元；臺北地院 113 智 3／智財商業法院 114 民商上易 1 認定三項未經同意公開行為均違反保密約定，將原告所請 30 萬元懲罰性違約金依民法第 252 條酌減為 10 萬元，連同返還價金 27.2 萬元合計 37.2 萬元；士林 113 訴 789、苗栗 113 苗簡 341、臺北 113 訴 609 三件公司借款及連帶保證判決本金合計 566 萬 7,241 元。五件判決金額合計 697 萬 5,241 元，另有桃園地院 113 促 431 的 1,376 萬 6,203 元支付命令；支付命令仍附 20 日異議權，本輪未確認異議、確定、執行或清償。所有金額都是歷史裁判／命令金額，不代表查核日仍有相同未清餘額。
- 收錄範圍限陳宜謙、`teemokayy` 與已由裁判書橋接的索爾斯科技。原帖列肯美廣告、爆炸行銷、淘設計、磐信管理諮詢、Nexw Tech／`nexwtech`、`conveymar` 及赴美成立公司／可能募資，但未提供足以擴張責任的直接橋接；不作 aliases／identifiers、不另建各公司卡、不把他人或公司責任混入。`Timothy Chen` 高度同名，也不作 standalone alias。證據檔：`evidence/user-submissions/2026-09-14-chen-yichian-programming-payment-claim-thread.png`，1290×1840 RGBA，已排除手機狀態列、Threads 導覽、下方無關貼文與回覆列；metadata 只保留 ICC；SHA-256：`d7f0b5e5d8b61642b1ce38f9b2b5da311ce6b254dbd2b9872c5970f29fa9bcb6`。
...
- 本案真正的店家同串回覆是 `https://www.threads.com/@mummu___87/post/DdOliddD_gz`：店家帳號稱照片為過去拍攝、照片中的砧板及相關器具已汰換、不是目前使用狀況，並接受「過去不足」之指教。這只支持店家稱已更換照片中器具及承認未具體指明的過去不足；店家沒有明說發霉、沒有逐一確認醋飯桶，也沒有承認曾用問題器具供餐、污染或違規。先前搜尋到的 `DW6bX-CD1lY` 是 2026-04-09 對另一則魚口感／魚腥味留言的回覆，不得誤接到本案。
- 店家 Threads 公開頁直接並列 `mummu___87`、穆木 Mummu、台南市東區裕農路87號與生魚片／壽司餐飲內容；第三方 2023 食記亦列相同店名與地址，故收錄範圍固定為這一公開對應據點，不擴及員工、照片人物、發文者、其他帳號或未確認據點。臺南市政府衛生局全文檢索與 TFDA 食品查核及檢驗資訊平台本輪未找到可歸屬該店的稽查、抽驗、命改善或裁罰結果；零命中不等於未通報、未稽查、沒有違規或已確認安全。Searchable fields 只保留穆木 Mummu 必要字形、日式料理組合、`mummu___87` 與完整地址；發霉、砧板、醋飯桶、食安、衛生局、改善、汰換、Threads、發文帳號與料理／餐廳泛稱不作 standalone alias／identifier。證據檔：`evidence/user-submissions/2026-09-14-mummu-tainan-moldy-cutting-board-thread.png`；SHA-256：`d78276c3a36c2a4629ffbd5cb7670ffafc7a98ac713b263577fa5222e5841a97`；1290×1745 RGBA，公開副本已移除圖片 metadata。
...
- Record：`zhang-qian-political-facebook-posts-personal-20260913`；`personal` / `high`。使用者提供 `sima.xuan` Threads 截圖並要求把畫面中沒聽過的藝人避雷。內嵌 Facebook 畫面顯示已驗證「張倩」頁面，正文為「這樣有印堂發黑嗎？」，張倩作者留言寫「哇！我都遮成這樣了！那群鳥蛙是有多怕呀🙄」。同一公開頁 `changchien1919` 的搜尋索引另可重現一則標題含「果然是蠢爛鳥蛙！」的本人頁面貼文，以及另一則批評「深信民進黨鬼話的人」並索引到「那群蠢爛鳥蛙該有報應」回覆的公開貼文。這些足以支持使用者因其公開政治評論語氣與對特定政治群體的貶稱，把張倩本人列為個人避雷。
- 證據邊界：外層 Threads 轉貼者所稱「成天發文在幹譙民進黨的人」及在民視、三立、公視拍戲「撈錢」只屬第三方評論，不作發文頻率、動機、收入或電視台立場事實。Facebook 公開貼文即時正文受存取限制，精確日期未讀回，不以相對時間推算；被馬賽克人物不辨識、不保存。`changchien1919` 公開頁自述台視／華視／三立角色，自由娛樂、公視官方節目頁再交叉確認演員身分；收錄只限張倩本人，不外溢電視台、劇組、平台、轉貼者、留言者或其他同名者。
- Searchable fields 只保留張倩及 `changchien1919`；張詩涵、鳥蛙、蠢爛鳥蛙、印堂發黑、民進黨、華國藝人、藝人、演員、民視、三立、公視、政治、Threads、Facebook 與帳號 `sima.xuan` 均不作 alias／identifier。證據檔：`evidence/user-submissions/2026-09-13-zhang-qian-political-facebook-thread.png`，由 1290×2796 原圖裁成 1290×1870，只保留目標 Threads 貼文、內嵌張倩 Facebook 貼文、作者留言及互動數字，排除手機狀態列、Threads 頂部導覽與下方無關貼文；metadata 只保留 ICC profile。SHA-256：`4ce8e6f166084fd538facf5dc68f8cb061bd6558e6ae590c488fa0d6f49b45de`；pixel SHA-256：`5ad86ce9c09ec8774175801676b199b7d1b6bbd37b129c74788a848bf8a3251f`。
...
- 截圖與報導所載時間線：發文者稱 1 月 9 日訂購印有「頑固台獨份子」的客製磁吸水壺，1 月 10 日收到以版權圖片或不雅文字等疑慮退單，1 月 11 日客服稱系統偵測到敏感文字、為保持中立而取消整筆訂單；發文者 1 月 12 日再以「中国一定要統一，一個點都不能少，解放台灣」測試，1 月 16 日收到發貨通知。犀牛盾 1 月 17 日官方聲明致歉，稱首筆是侵權圖款誤判、客服措辭不當，否認依個人言論／政治立場／宗教選擇審查或使用言論審查系統，並稱已檢討判讀流程、協助完成所有訂單；台視與壹蘋另報導原始訂單後續完成；原作者之後表示「這次的事件可以收尾了」並請大家不用再追殺公司。現行官方客製規範經 Zendesk API 讀回，列侵權、違法、不雅、歧視等限制但未把一般政治立場文字單列為禁止項目；現行頁面不能反推 2024 年條款完全相同。個人避雷主因是不同處理結果與前後說明造成的消費信任疑慮；不得改寫成中資、官方承認政治審查、故意支持中國統一、違法或 2026 年仍沿用同一判讀方式。
- Searchable fields 只放犀牛盾、RHINOSHIELD 必要字形、`rhinoshield.tw`、`rhinoshield.io` 與 `rhinoshieldtw`；敏感盾、發文帳號、政治口號、雙標、客服、磁吸水壺、AquaStand、平台／媒體名與訂單號碼不作 alias／identifier。公開證據檔：`evidence/user-submissions/2026-09-10-rhinoshield-custom-order-review-thread.png`，由原始 1290×2796 截圖裁成 1290×2310，移除下方訂單號碼、訂單圖片及回覆列無關頭像；只保留 ICC profile。sanitized SHA-256：`9c78424a0d2af2371ed31ea55ca8268b68a877f7e49f38eba463cb89a4e0e93a`；pixel SHA-256：`6f84ad58637c5ea4997550b663812d5ce83a4f26d275e97a9fa60ed5d6893be2`。
- TDD／驗證：先執行 target-only validator，因 target ID 不存在而 exit 1（RED）；新增紀錄後完成 merge、target-only 正反向查詢、完整 validator、Node tests、source／generated parity、idempotence 與 `git diff --check`。生成資料為 315 筆（風險 309 筆），10 項完整檢查為 `warnings: 0; errors: 0`，Node tests 14/14；source／generated target 均恰一筆且八個來源內容一致；merge 重跑 `brands.json` SHA-256 為 `0580dc7332cea85297810b90ce07c04a40ea5e7c0ef6ec5c8a779d7ca60acd93`。
...
## 2026-09-13 民進黨台北市黨部違紀／退黨參選呈報名單：5人個人避雷

- Record：`taipei-dpp-five-disciplinary-resignation-candidates-personal-20260913`；`personal` / `high`。使用者提供 Threads 截圖並明確要求避雷圖中5人。中央社與自由時報依民進黨台北市黨部2026-09-13新聞稿交叉確認：違紀參選3人為台北市第四選區（中山、大同）陳怡君、朱政騏及新北市第三選區（新莊）簡麗花；退黨參選2人為台北市第六選區（大安、文山）陳峙穎及台北市第一選區（士林、北投）紀建漢。市黨部依黨內「公職候選人提名條例」第12條將名單呈報中央黨部核備。
- 中選會2026-09-07製表的官方直轄市議員候選人登記彙總表確認5人均已辦理登記：紀建漢—台北市第1選舉區、無政黨推薦；朱政騏、陳怡君—台北市第4選舉區、無政黨推薦；陳峙穎—台北市第6選舉區、時代力量推薦；簡麗花—新北市第3選舉區、無政黨推薦。登記資料不等於最終候選資格審定，也不單獨證明黨紀結果。
- 程序界線固定：截至2026-09-13，朱政騏已於5月13日經民進黨中評會決議除名，且4月8日已遭中執會撤銷議員提名資格；陳怡君於2月4日遭停權2年6個月、2月25日遭撤銷此次黨內參選資格，9月自行登記後是提報中央中評會議處，不能寫成已開除黨籍或曾獲正式提名後遭撤銷；簡麗花因黨籍資料歸屬台北市黨部而提交中央黨部查核，未見最終處分；紀建漢2月10日已申請退黨，陳峙穎與紀建漢是退黨參選，不得改寫成違紀參選或遭黨紀處分。市黨部新聞稿提到有遭除名者疑冒用黨徽，但未具名，不得歸責任何特定一人。不得把黨紀／退黨參選等同違法、刑事有罪、候選資格無效或客觀不當定論。
- `aliases`只放5個正確姓名；政黨名、選區、違紀參選、退黨參選、黨紀、除名、候選人、Threads、媒體名及評論詞不作搜尋鍵。證據檔：`evidence/user-submissions/2026-09-13-dpp-five-disciplinary-resignation-candidates-thread.png`；sanitized SHA-256：`658eb627b96fbdfdcf9ba8fb43607475d9b9ecd9a4f163f5a7209cfa50ef9c29`；pixel SHA-256：`16b27d57b6195ffcd5f831b6aa0241231e74fdc22f913d4706f95e4a1e1b0450`；公開副本已移除EXIF、XMP、DPI與自由文字metadata，只保留ICC色彩描述，RGBA像素未變。

## 2026-09-09 民進黨宜蘭縣黨部違紀參選提報名單：9人個人避雷

- Record：`yilan-dpp-nine-disciplinary-referral-candidates-personal-20260909`；`personal` / `high`。使用者提供 Meta AI 對話截圖並明確要求避雷其中9人；中選會候選人登記彙總表核對9人姓名、層級與選區，自由時報、葛瑪蘭新聞網及聯合新聞網再交叉確認，民進黨宜蘭縣黨部2026-09-07執委會將羅淑惠、謝燦輝、林瑞文、吳秋玟、陳玉麟、蔡莉雯、簡鳴佐、梁文德、陳美華列為違紀參選名單並提報評議委員會議處。中選會表列9人推薦政黨均為「無」；此欄只反映候選人登記，不可單獨推論黨籍或黨紀結果。
- 職務／選區固定為：羅淑惠—五結鄉長；謝燦輝—冬山鄉長；林瑞文—頭城鎮選區宜蘭縣議員；吳秋玟—礁溪鄉選區宜蘭縣議員；陳玉麟—員山鄉選區宜蘭縣議員；蔡莉雯—羅東鎮民代表第三選區；簡鳴佐—羅東鎮民代表第四選區；梁文德—三星鄉民代表第三選區；陳美華—五結鄉民代表第五選區。聯合新聞網單篇寫成「簡嗚佐」，但使用者截圖、自由時報與葛瑪蘭新聞網一致為「簡鳴佐」，故誤植不作alias。
- 截至2026-09-09，案件仍是縣黨部提報評議程序；只能寫「最重恐開除黨籍」，不得寫成9人已正式被開除、違法、候選資格失效、初選皆落敗後翻桌或破壞團結已成客觀定論。`aliases`／`identifiers`只放9個正確姓名；canonical `name`僅保留「2026黨紀提報」作最小事件辨識，不把政黨、地名、職務、違紀、開除黨籍、Meta AI、媒體名或評論詞加入aliases／identifiers。證據檔：`evidence/user-submissions/2026-09-09-yilan-dpp-nine-disciplinary-referrals-meta-ai.png`；sanitized SHA-256：`36b684e317da01c8eaaf30113931bda53fd95c4ed09e37ffab9da2be12c87f4b`；pixel SHA-256：`64ab7e79a435f2abf4fb5f7f59e806e6ada400ba34aae690eb8cabcb88c55289`；公開副本已移除EXIF、XMP、DPI及自由文字metadata，只保留ICC色彩描述，RGBA像素不變。
- Category source literal 使用 README 固定大類 `政治／政黨人物名單`；`record()` 會依 `data/record-helpers.mjs` 的全域既有映射產生前端 canonical 值 `政治／政黨名單`。這是整個資料管線的既有正規化行為，不得為單筆紀錄移除全域映射。

## 2026-09-09 阿城鵝肉土城總店經營體系：香港兩岸／故土文宣與吉林體系排除

- Record：`acheng-goose-tucheng-system-cross-strait-copy-personal-20260909`；`personal` / `high`。使用者以無文字 Threads 截圖提供避雷線索；依 screenshot research-first gate，先核對阿城鵝肉土城總店體系與台北中山吉林體系的官方 Facebook，再以聯合新聞網、TVBS 補足日期、適用門市及經營邊界。土城體系官方 2026-08-28 優惠提醒附圖保留香港文宣實物，可直接讀到「親愛的同胞」、「阿城鵝肉起於台灣，興於香港，歸於故土」及「灶臺上的老滷，熬的是團圓，不是別離」；官方 2026-09-06 又承認是「來自香港阿城鵝肉的文宣」，並稱已重新整理文字。具名媒體讀回原文另含「品牌能興於兩岸三地」，及店家回應「政治歸政治，生意歸生意」。這些足以支持使用者因跨海政治文宣與後續危機處理而個人避開，但「統戰鵝肉」只屬網友批評標籤，不得寫成政府認定、中共指揮／資助、違法或食品品質問題。
- 範圍固定為土城總店經營體系：土城總店、三峽北大店、桃園機場店及其香港／深圳相關品牌發展；可直接確認九折文宣適用的香港門市為太古城、淘大／九龍灣、東薈城／東涌。台北中山吉林團隊官方明載吉林店與土城總店在人員、營運、財務、管理上各自負責多年，吉林一、二、三店已改用新 Logo，因此明確排除；不能只因都使用「阿城鵝肉」字樣而共擔本次文宣責任。TVBS 所述其他同體系據點只支撐經營邊界，不代表每個據點都參與文宣決策。
- Searchable fields 只放土城體系名稱、直接具名門市、`A CHENG GOOSE`、`AChenggoose` 與 `acheng.com.tw`；台北中山阿城鵝肉、吉林一／二／三店、Threads 帳號、媒體名、政治、統戰、同胞、兩岸三地、故土、團圓、9折、Google評論、簡體字與其他理由／來源／泛稱均不得命中此卡。證據檔：`evidence/user-submissions/2026-09-09-acheng-goose-political-copy-thread.png`；sanitized SHA-256：`96e318ff81fce0763c2c669860494df9524a1d4538f882a6aa682facf0072d01`；pixel SHA-256：`64d6bef2c644742d33805a464f5bc109b29b1a3d8974c1f52a690156083bd5ab`。公開副本已移除 EXIF、XMP、DPI 與自由文字 metadata，只保留 ICC 色彩描述，RGBA 像素未變。

## 2026-09-05 中華民國輕艇協會第十屆公開幹部：世錦賽經費溝通爭議的關聯式個人避雷

- Record：`taiwan-canoe-association-tenth-board-public-officers-personal-20260905`；`personal` / `high`。使用者提供宋雋熙輕艇水球世錦賽參賽經費爭議截圖，並明確要求「這協會的人避雷」。採最小可確認範圍，只收中華民國輕艇協會官網 2026-08-07 公開的第十屆21名幹部（任期115.3.8–119.3.7）：理事長王美月、秘書長張至滿、4名副理事長、1名常務理事、9名理事、1名常務監事及4名監事；不收選手宋雋熙、教練、其他國手、一般會員、工作人員、贊助者、運動部長李洋或其他協會。
- 事件證據分層：宋雋熙主張3月底選拔後被告知沒有自費項目，9月2日才通知每人約10萬元、退出仍須近6萬元；協會2026-02-12公布的官方PDF可獨立確認，競賽規程第十五點及教練／選手遴選辦法第九點均載「除運動部補助外，不足部分需自籌」，但沒有每人金額、通知／繳款時間、分攤方式或退賽費計算；協會9月聲明另稱7月2日及8月26日已說明可能自費，10萬5,300元是階段性試算；運動部則要求協會充分說明金額、繳費時間與費用內容，逐項核實取消支出並建立更明確的事前揭露、溝通及選手權益保障原則。不得寫成免自費承諾已客觀證實、協會詐騙／勒索／違法、取消費確定不得退，或21名幹部均親自決策、知情、參與通知或負有個別責任。
- Searchable fields只放21個官方姓名，並由 canonical name 保留名單識別；不把職稱、國手、輕艇水球、世錦賽、自費、10萬、6萬、宋雋熙、李洋、Threads、德國、募款、運動部等理由／人物／平台／泛稱作alias／identifier。證據檔：`evidence/user-submissions/2026-09-05-taiwan-canoe-association-world-championship-fee-thread.png`；SHA-256：`66f87ce2199fba8c285341f454ce51621b8fcbbcb0e8780c789f1cb7cb267a07`；pixel SHA-256：`7e44d45c51ca659a75e71c58012a07743bc817e25946f74e7322dd73d663501a`。公開副本已移除 EXIF orientation、XMP、DPI 與自由文字 metadata，只保留 ICC 色彩描述，RGBA 像素未變。

## 2026-09-05 淡水新春街疑似投藥案：撤回錯誤具名歸屬

- 原紀錄 `great-tree-tamsui-xinchun-branch-chen-changsheng-suspected-drugging-personal-20260904` 將案件歸到「大樹藥局－淡水新春店／新春藥局／陳長昇」，但原始截圖只寫「新北淡水 新春街的藥局」，招牌被馬賽克，沒有可讀店名、門牌或完整姓名；依玻璃門、灰牆、地磚、坡道扶手等常見外觀對應新春街189號不足以排除同街其他藥局，因此已完全移除該具名歸屬。
- 使用者後續提出陳慶鴻線索。中央社／三立只將案件對象寫成新春街某藥局的50歲陳姓藥師；三立另描述高醫臨床藥學碩士、長期任職台北榮總藥學部與感染科加護病房重症藥學等特殊經歷。臺北榮總2014年官方課程表與台灣醒報2015年具名資料可確認陳慶鴻過去的臨床藥師／感染科職歷，中華黃頁公開機構資料可確認新春街96號昱承藥局及所列負責人陳慶鴻。這些線索高度吻合，但仍屬跨來源拼圖；警方、檢方、法院及已查得的具名可信媒體均未直接公開完整姓名、店名或門牌，依 `unnamed-local-business-criminal-claim-intake` 不足以公開點名。
- 結論：目前不建立「昱承藥局／陳慶鴻」案件紀錄，也不恢復「大樹藥局淡水新春店／陳長昇」紀錄。只有日後官方或具名可信媒體直接完成店名／地址層級橋接，才能重新評估最小範圍收錄；不得以人臉、門面外觀、同街名冊、姓氏、年齡或特殊職歷拼圖替代直接身分證據。
- 案件程序仍限於警方搜索、BZD類別初篩及函送士林地檢署偵辦；不得寫成FM2正式鑑定、已起訴、已判決有罪或定讞。媒體／第三方所述犯罪意圖、性騷擾、離婚或其他私人情節不得升格為司法認定。
- 舊事件證據仍為 `evidence/user-submissions/2026-09-04-tamsui-xinchun-pharmacy-suspected-drugging-news-thread.png`；SHA-256：`ed036f033dc00ae5a867da08176b0cb2685b3e02f5cc7e4dec8610860493e811`；pixel SHA-256：`b073a0664f14d4b63a3eda4fd47b29de24396dd17d52604a98fa723f3d987205`。2026-09-05補充截圖只作查核線索，未形成可發布的直接身分證據，因此不另保留 repo 證據副本。

## 2026-09-05 哈利路亞家教會：官方週報正面推廣習近平政治論述

- Record：`hallelujah-home-church-xi-political-message-personal-20260905`；`personal` / `high`。使用者提供 Threads 截圖並要求避雷；真正入庫理由採教會官方資料，而非轉貼者。官方網站公開名稱為「哈利路亞家教會／Hallelujah Home Church」，隱私政策明載網站與服務由「社團法人中華民國哈利路亞社區關懷協會」提供並維護；司法院2026-08-25公告確認同名協會第8屆理監事於2026-08-24登記、代表法人之理事賴慧珊與常務監事曾英欽。收錄範圍限教會品牌、其法律營運實體及官網列出的台北／中壢堂點名稱，不擴及信徒、會員、同工、員工、與會者、留言者、轉貼者或牧者個人。
- 官方第1736期週報《野橄欖的春天》（2026-08-30）第2頁正面稱習近平為「習大大」，稱其定意「以中國式現代化全面推動中華民族的偉大復興」並說是「造福整個世界」；第20頁再次要求信徒以同一口號投入中華民族偉大復興。這足以支持使用者因該組織官方正面引用／推廣習近平政治論述而個人避開，但不得外推為已證實接受中共指揮、資助、隸屬中共、犯罪或非法。
- Threads原帖發布者是顯示名稱Jeff的 `@tomorrow_yes`，其文字、憤怒表情與 `#邪教組織` 是批評，不是教會官方表態；「中央哈利路亞家教會」是Threads主題標籤，不是帳號名、官方組織名或法律實體。故 `tomorrow_yes`、Jeff、「中央哈利路亞家教會」、曾英欽與賴慧珊都不作本紀錄alias／identifier；也不把「邪教」寫成政府或司法定性。searchable fields只保留正式教會／協會名稱、官方英文名、兩個官方堂點名稱與 `alive.org.tw`。
- 證據檔：`evidence/user-submissions/2026-09-05-hallelujah-home-church-thread.png`；尺寸1290×1536；SHA-256：`59a7799a37819c0e36e83605c1528b6e42c20801c0c863097d633ea7fc98b425`；pixel SHA-256：`1755e634f5d6312081edfda181ffb6e05cef6722a32c12cb0f1c4473b55801d7`。公開副本已裁除下方無關第三方留言者、帳號、頭像及回覆輸入列，只保留必要貼文內容；metadata只保留ICC色彩描述。

## 2026-09-05 王健陞：乘機性交未遂判刑定讞與五分里里長登記

- Record：`wang-jiansheng-wufenli-candidate-sexual-offense-final-conviction`；`confirmed` / `high`。司法院具名裁判鏈確認：臺北地院108年度侵訴字第19號認定王健陞趁被害人酒醉熟睡、不知抗拒而著手性交，因被害人醒來抵抗而未遂，判1年10月；臺灣高院109年度侵上訴字第247號駁回上訴；最高法院110年度台上字第4057號於2021-07-29駁回上訴而定讞。臺灣高院112年度聲字第202號另載其送監執行後於2023-01-10獲准假釋，付保護管束；不能把假釋誤寫成撤銷定讞或無罪。
- 身分橋接不是同名推定：一、二審具名裁判都記載王健陞任市議員助理、父親任里長；臺北市選委會2026-09-04官方登記冊第30頁則列「臺北市內湖區五分里／115-09-02／序號2／王健陞／無政黨推薦」。這證明已辦理候選人登記，不等於候選資格已審定；截至2026-09-05，選委會公開回覆仍稱須由委員會審議。
- 多家具名媒體稱王健陞曾改名王辰栩、後改回本名；`王辰栩`因此只作「媒體報導曾用名」alias，不寫成法院或戶政正式證實。收錄限王健陞本人，不擴及父親、被害人、議員、政黨、五分里居民或其他同名者；「五分里」「里長」「議員助理」「性侵犯」等泛稱不作standalone alias／identifier。
- 證據檔：`evidence/user-submissions/2026-09-05-wang-jiansheng-wufenli-candidate-news-screenshot.png`；尺寸1290×2360；SHA-256：`da07695727502e1a37cb723190d19d9b147cb3d976b995a8ec0cc2913c7181c9`；pixel SHA-256：`03d2d48460f386f6f1f8937b41dcda25154b530f29e97e95f79050b6ce68ecf4`。公開副本已裁除下方重複帳號列與含非必要頭像的回覆輸入列，只保留必要貼文內容；metadata只保留ICC色彩描述。圖卡只作使用者指定與查核線索，法院定讞及登記事實以司法院、選委會原始資料為準。
...
- Instagram 頁面標題只橋接店名與帳號；Google Maps 只橋接同名餐廳、臺北市大安區及 inline 預約服務。現有可讀來源不足以識別或驗證具名日本投資方、監修方、技轉方、百年合作名店及股東結構；也不能反向斷言這些關係不存在。範圍限具名餐廳／帳號，不擴及發文者、留言者、inline、其他祇園餐廳、未具名股東或任何日本業者。不得查詢、保存或輸出台灣統編、股東個資、電話與完整地址。Searchable fields 只保留店名必要標點變體、ZEN SAN 與 `zenin.sukiyaki.tw`；發文者／留言者帳號、平台、來源疑問詞、料理評論、地址及日本投資等理由詞不得作 alias／identifier。
- 使用者後續明確補充：二本松、橋山、祇園禪院為同一位老闆，且三者社群會互相發文介紹。這是應耐久保留的 relationship lead，但在取得共同所有權文件或可重現的三方官方社群互推貼文前，不得寫成已獨立證實，也不得據此自動把祇園禪院避雷範圍擴張到二本松／橋山。2026-09-02 的 Google Maps 查核顯示「二本松涮涮屋 本館」與「橋山.壽喜燒」是相鄰的獨立店家頁，且當時顯示相同公開聯絡電話，可支持兩者存在直接營運聯繫；但同電話不足以單獨證明共同老闆，也未橋接祇園禪院。不得保存該電話數值或完整地址；二本松／橋山也不得成為祇園禪院紀錄的 alias／identifier。
- 證據檔：`evidence/user-submissions/2026-09-02-gion-zenin-sukiyaki-threads-transparency-question.png`；SHA-256：`15b254b8554feb105061dba1af22395bd46b1c3d0db8808546859ef3ee84a7a0`。原 PNG 的 EXIF orientation、XMP 建立／修改時間、DPI 與 Screenshot 自由文字已從公開副本移除，只保留 ICC 色彩描述；RGBA 像素未改變，pixel SHA-256：`8cf29bc7e5e4cca3dcca561f3cf6eb266b9c985feed32dfb0e5a936a5e995663`。
...
- 本筆不把未完整審閱的整段影片序列寫成已確認內容。使用者保存的 PNG 是 Threads 影片介面的單一定格截圖；該定格只直接支持一台壁掛電視顯示帶有「浙江衛視」識別的節目畫面，不能由單一定格判定訊號來源、即時頻道直播／網路串流／重播片段、選播者、播放期間、管理政策或法律責任。第二台電視與中視新聞沒有出現在使用者提供的截圖，只能寫成原發文者的文字陳述。留言中的「滲透」「盜版電視盒」「老闆中國人」等均屬未證實推測，不採為資料事實。
- 國立清華大學總務處事務組官方頁面明列「水木生活中心（包括水木餐廳）」，另有水木餐廳「商場及公共區域特清／客席區暫不開放」公告；這些第一方來源只完成校內場域與公共客席區身分橋接，不證明事件、拍攝位置、目前營運商、選播者、攤商責任或校方立場。收錄只限水木餐廳公共用餐區，不擴及國立清華大學整校、校方人員、各攤位、浙江衛視／中視、節目人物、發文者或留言者。
- Searchable fields 僅保留水木餐廳與水木生活中心的具名場域組合；由於查詢核心採 substring，為避免只查「清華大學／清大」也誤命中這張場域卡，不把校名寫入 `name`、aliases 或 identifiers，學校歸屬只留在摘要與官方來源。餐廳、水木、校本部、公共用餐區、浙江衛視、中視新聞、中國、節目、滲透、盜版、Threads、帳號及留言者不得另作 standalone alias／identifier。證據檔：`evidence/user-submissions/2026-09-01-nthu-waterwood-restaurant-zhejiang-tv-thread-screenshot.png`；檔案 SHA-256：`089e78ce443d909b665a083eefcda283034cea03f6a94237e5477c2995d26881`；pixel SHA-256：`47eba2cbd6161f70b44b32201634a685d77d0c68a926ac98aeb2048d2c2061f8`。入庫前已移除 EXIF／XMP 與路徑型 metadata，只保留 ICC 色彩描述，RGBA 像素完全不變。

## 2026-09-01 護樹團體社群清單：11 個團體逐筆個人避雷

- 使用者提供一張帶有 Facebook／Threads／Meta AI 來源泡泡的護樹團體整理清單截圖並明確表示「全部避雷」。新增 11 張獨立 `personal` 團體卡：台灣樹人會、台灣護樹團體聯盟、台灣護樹協會、社團法人台灣森林城市協會（截圖寫森林城市協會）、台灣真美樹協會、撫遠公園護樹聯盟、松菸護樹聯盟、松山護樹志工團、城南老樹巡守隊、筑樹小丘護樹工作室、幸町老樹保護行動。逐團體建卡而非合併一張名單卡，避免查詢與責任範圍互相污染；不把人物、會員、志工、合作對象、來源平台或所有環保／護樹倡議者納入。
- 這張圖是社群／AI 整理列表，不是各團體官方共同聲明，也沒有提供具體負面事件；避雷只代表使用者個人選擇，不得自行推定使用者反對護樹、都市開發、老樹保存、地方自治或特定政治立場，也不得寫成違法、裁罰、不當行為或各團體共同參與某事件。除「松山護樹志工團」只在截圖可見而維持 `low` 外，其餘 10 個名稱均有政府名冊、官方頁面或具名公民媒體來源作身分／字串橋接，採 `medium`；外部來源只作名稱橋接，不是避雷理由。
- 畫面末端只顯示「幸町老樹保護……」且被截斷；同期公民行動影音紀錄資料庫在相同順序直接列出「城南老樹巡守隊、筑樹小丘護樹工作室、幸町老樹保護行動」，因此安全補全為「幸町老樹保護行動」。歷史名稱「幸町百年老樹聯盟」與另見變體「幸町老樹守護行動」的組織／法律連續性未證實，兩者不作新卡 aliases；幸町百年老樹聯盟恢復留在既有 `tree-party-tree-protection-public-figures` 混合人物卡。另有公開來源明確並列「松菸護樹志工團」與「松菸護樹聯盟」，但沒有來源證明前者等同截圖所寫「松山護樹志工團」，兩者不得合併或互作 alias。
- 舊人物卡中的台灣護樹團體聯盟、社團法人台灣森林城市協會／台灣森林城市協會／森林城市協會已移出 searchable aliases，由本次獨立團體卡承接；未獨立確認的反向名稱「城市森林協會」與「高雄愛樹人」不再作 searchable alias。`土城護樹者聯盟` 與 `幸町百年老樹聯盟` 不是本圖確定目標，仍留在舊名單。同一司法院法人登記公告在新團體卡與既有舊人物卡的來源日期均統一為官方頁所載 `2023-08-31`，避免相同 URL 前後矛盾。
- 證據檔：`evidence/user-submissions/2026-09-01-taiwan-tree-protection-groups-list-screenshot.png`；SHA-256：`c86e49d79cc12124f250c86aaa2f846447edd6b7e654753ec01a7d1cc35a4c2b`。入庫前已剝除 EXIF/XMP 與路徑型 metadata，只保留相同 RGBA 像素及 ICC 色彩描述；pixel SHA-256 為 `66906f9fbdd9685ed5ee2dce52bd1a384bfa272ad3baab9a9515a1de15f81903`。Source registry 285→296、`brands.json` 291→302。TDD 第一輪 pre-merge 11 個 query=>ID expectations 如預期 RED；幸町由暫接百年老樹聯盟更正為保護行動後，新的 query=>ID 亦先 RED。產生器會保留舊 ID，故精確移除一次性暫接 generated card；其後連跑兩次 merge 皆維持 296 source／302 total，確認不會復活。最終 11 正查、88 個通用 `--not-expect` 與 3 個松山／松菸及幸町隔離 probes 全部 GREEN、warnings/errors 皆 0；11/11 唯一命中、source/generated parity 通過；全量 validator 10 checks、Node tests 12/12、`git diff --check` 與 added-lines 安全掃描均通過。此靜態站沒有 `package.json`、Tauri 設定或版本欄位，不做不存在的版本遞增。

## 2026-09-01 947修手機－台北景美門市：開發票另加 5% 單方主張與單店避雷

- Record：`947-phone-repair-jingmei-invoice-surcharge-claim-personal-20260901`；`personal` / `medium`。使用者提供 Threads 截圖，畫面顯示公開帳號 `davis_liao_tw` 自述 2026-08-31 下午前往景美手機店維修，遭告知開發票要加 5%；內嵌影片定格可見 947修手機招牌、Google Maps 的景美門市標示、詢問收據字幕及 2026/8/31 18:07 時間。截圖沒有完整影片、正式報價、交易／付款紀錄、收據或發票、店家回應及主管機關認定，只能作發文者單方主張與使用者 intake，不能寫成逃漏稅、拒開發票、違法、已遭檢舉／裁罰或店家承認。
- Google Maps 現列「947修手機－台北景美門市」、臺北市文山區羅斯福路六段 323 號，可橋接截圖中的店面與特定門市；Maps 不是公司／商業登記、品牌授權或加盟資料，不足以認定景美門市與其他 947／947PLUS 據點屬同一法律主體、直營或加盟。收錄只限台北景美門市，不擴及 947修手機整體品牌、其他門市、員工或同名店家。
- 《加值型及非加值型營業稅法》第 32 條明定應稅貨物或勞務定價應內含營業稅，非營業人買受時應按定價開立統一發票；若原金額確為一般消費者的正式維修定價，只因要求發票才外加 5%，與含稅定價規則不符。仍須保留前提：未確認門市發票使用資格、原金額性質與完整交易，且小規模／特殊性質營業人可能掣發普通收據、免用統一發票。Searchable fields 僅 947修手機＋景美／台北景美門市的具名組合與 `947PLUS 景美門市`；`947修手機` 單獨、手機維修、景美、發票、收據、5%、加收、逃漏稅、Threads、帳號、地址、電話等不得作 alias／identifier。證據檔：`evidence/user-submissions/2026-09-01-947-phone-repair-jingmei-invoice-surcharge-thread.png`；SHA-256：`53804b82847f76da53bd2a9774723e745f7dff2e9c1b4d99705d72130ab562cc`。
...
- 依使用者固定規則「食品品牌涉中國製造即全品牌避雷」，PASSION 24／果力醒採全品牌個人避買。必須保留限定：PChome 同款 235ml 果力醒商品列原產地台灣、廠商蕓鼎企業；沒有證據證明中國合作工廠參與該 SKU、PASSION 24 自有品牌或照片中這一罐，也沒有證據證明蘋果汁、百香果汁、紅景天、葛根等原料來自中國。不可改寫成這罐或全系列都中國製，也不把食品廣告處分擴寫成產品不安全、假標、污染、抽驗不合格、召回或禁售。
- 官方商品頁列 99% 百香果與蘋果汁、枳椇子／紅景天／葛根萃取；PChome 成分欄另列水、麥芽糊精、檸檬酸、調味劑與鹽，產品說明圖只稱枳椇子為韓國進口，其餘主要原料批次產地未公開。食藥署官方違規食品廣告資料另列『PASSION 24 果力醒 元氣機能果汁飲』、蕓鼎企業、臺中市政府衛生局於 2024-12-10 依食安法第 28 條第 1 項處分結案；只能寫食品廣告不實／誇張／易誤解規範下的處分，不猜具體違規文句或罰鍰，不擴成產品污染、抽驗不合格、召回或禁售。主因固定置首為品牌所屬公司官方自述中國合作工廠，廣告處分與原料透明度作次要補充。searchable fields 僅 PASSION 24、PASSION24、果力醒及具名組合；WAKE、蕓鼎、中國、合作工廠、機能果汁、99%、食品廣告、第 28 條、平台名、食品業者字號、電話、地址與原料名不得另作 standalone alias／identifier。證據檔：`evidence/user-submissions/2026-08-29-passion24-wake-functional-juice.jpeg`；SHA-256：`69eeb2beb7c076809ef39752c2338c901ecba3b56dee5e326759e13b30dc3f0c`。

## 2026-08-29 蛋白盒子：中國進口青花菜自述與全品牌個人避買

- Record：`protein-box-china-broccoli-whole-brand-personal-20260829`；`personal` / `medium`。使用者在持續進行的 image-only 避雷收錄中提供 Threads 截圖；帳號 `17ivanxo` 嵌入的回覆帶有「蛋白盒子／健康餐」紅色品牌圖樣，文字直接寫「我們的青花菜來自中國進口」，並稱為避免台灣季節交替造成產量與品質不穩而選用進口冷凍品。
- 依使用者固定規則「中國來源食品直接避買；食品品牌涉中國來源食品即全品牌避雷」，蛋白盒子採全品牌個人避買。直接證據仍只支持這張品牌回覆截圖的青花菜來源自述；沒有原始回覆 permalink，不宣稱已從平台獨立驗證帳號控制權，也不擴成每家分店、每份餐盒、全部食材或所有批次皆中國製。回覆括號稱「市面上冷凍青花菜95%來自中國」但未附來源，不採為已驗證市場統計。
- Google 地圖可確認多個台北據點使用「蛋白盒子健康低卡餐盒」名稱，只作品牌身分橋接，不驗證用料。searchable fields 僅蛋白盒子品牌與完整店名變體；青花菜、花椰菜、中國、95%、Threads、帳號與地址不得另作 standalone alias／identifier。查詢核心採 substring，因此「健康餐」「餐盒」等實際完整品牌名片段仍可能命中，這不代表另行把泛稱加入 aliases。證據檔：`evidence/user-submissions/2026-08-29-protein-box-china-broccoli-thread.png`；SHA-256：`68ed7ced15b4a4ef9bdc068046f6421bf1925c0267c983d2d688d8a611dd3002`。

## 2026-08-29 馬祖牡蠣／生蠔：中國來源混充風險的來源未核驗品項避買

- Record：`matsu-oyster-china-origin-laundering-personal-20260829`；`personal` / `high`。使用者提供 Threads 截圖引用《上下游》2024 年「中國牡蠣如何變成馬祖生蠔？」調查；原專題由楊語芸具名採訪，描述中國福建黃岐牡蠣透過海上交易進入馬祖，再以馬祖生蠔名義運台。三立 2024-11-13 具名報導另引述農業部長陳駿季表示將推動養殖／數量登記、來源勾稽並加強走私查緝，並說明中國活體、生鮮、冷藏及冷凍牡蠣不得進口，僅殼長2公分以下蚵苗符合規定。
- 《上下游》從網路商城、水產行及富基、竹圍、梧棲三處觀光漁市購入6件匿名樣本送振泰檢驗，文章列鎘值1.31–2.33 ppm、高於其引用的1 ppm標準；甲基汞、無機砷未檢出，微生物檢驗呈陰性。這是媒體自辦6件抽樣、店名隱去，不得外推成全市場100%超標、全部店家違法或2026年所有商品仍相同。
- 避買範圍固定為僅以「馬祖牡蠣／馬祖生蠔」名義販售、合法來源與溯源無法核驗的商品；不可反向宣稱所有馬祖在地養殖、具可信溯源或連江縣證明標章商品都是中國走私品。searchable fields 只放馬祖牡蠣／生蠔的具名組合；中國、走私、洗產地、鎘、重金屬、超標、Threads、帳號及媒體名不得另作 standalone alias／identifier。查詢核心採 substring，因此「馬祖」「牡蠣」「生蠔」等實際名稱片段仍可能命中，這不代表另行把泛稱加入 aliases。證據檔：`evidence/user-submissions/2026-08-29-matsu-oyster-china-origin-laundering-thread.png`；SHA-256：`e99f52de5d601462c5fda8f241ba8aff4840fd7605c6acb540fe41801a7fc6e0`。

## 2026-08-29 南州小田本舖：前員工衛生指控截圖的低可信度個人避雷

- Record：`nanzhou-oda-honpo-former-employee-hygiene-thread-personal-20260829`；`personal` / `low`。Threads 帳號 `kkioserlk` 在使用者提供的截圖中自稱南州小田本舖前員工，提出鼠患、客人剩湯過濾後倒回熬湯鍋、食材冷凍微波、冷凍庫雜亂異味、食物落地後再供客等單方指控，並要求大眾不要光臨。
- 截圖附圖只直接顯示部分後場工作區；右圖可見高麗菜與設備標示「請勿放食品在上層退冰吹乾」，左圖模糊，無法獨立證實發文者任職身分或其他文字主張。未取得原始貼文 permalink、任職證明、店家回覆、衛生局稽查、裁罰或其他獨立來源，因此只按使用者個人風險選擇入庫，不寫成衛生違規、食安危害、違法、裁罰或店家承認已成立。
- 屏東縣政府交通旅遊處『屏東購GO』店家頁列出『小田本舖』、南州鄉三民路92號、電話及官方 Facebook `oda.honpo`；Google 地圖同名 POI 的名稱、地址與電話亦相符。這些來源只用於店名／所在地／官方社群身分橋接，不證明法律登記主體或貼文指控。收錄範圍限這家具名店，不擴及拉麵店泛稱、員工、供應商或其他同名者；searchable fields 僅南州小田本舖、小田本舖與 Oda Honpo 組合。查詢核心採 substring，因此「南州」等實際完整店名片段仍可能命中，這不代表另行加入地名 alias。證據檔：`evidence/user-submissions/2026-08-29-nanzhou-oda-honpo-former-employee-hygiene-thread.png`；SHA-256：`431f6bd99a190b440772d8464314f162bbefa8b570f46e167827ed7595cbd9d4`。

## 2026-08-27 茶裏王：中國原產 SKU 證據與全品牌個人避買

- Record：`cha-li-wang-china-origin-food-whole-brand-personal-20260827`；`personal` / `high`。此筆由舊 `cha-li-wang-zhengshan-xiaozhong-moli-longjing-sku-personal` 兩款 SKU 紀錄升級。使用者提供的 Threads 截圖內含茶裏王茉莉龍井瓶身照片，標籤可直接讀到原產地中國及進口商統一企業股份有限公司；自由時報 2026-05-12 報導茶裏王正山小種、茉莉龍井兩款 7-11 限定商品生產地標示中國，並引述統一集團發言人表示兩款茶使用中國茶葉、引進販售流程合乎法規。
- 依使用者既定規則「中國製食品直接避買；食品品牌出現中國製商品即全品牌避雷」，本筆將茶裏王全品牌列為個人避買。直接證據仍只確認上述兩款 SKU，不得改寫成茶裏王每款商品皆中國製，也不作食安、違法、假標、禁售、中資定論；本筆不外溢到統一企業全品牌、其他統一品牌、7-11、貼文帳號或一般中國茶商品。截圖貼文作者稱統一進口中國茶葉並倒掉飲品，僅作作者陳述；原產地中國則由瓶身照片直接支持。
- Searchable fields 僅 `茶裏王`、`茶裡王`、`茶里王` 與茶裏王＋正山小種／茉莉龍井的具名組合；`查理王`、中國、台灣、統一、統一企業、7-11、瓶裝茶、茶飲、正山小種、茉莉龍井、Threads、貼文帳號、產地、進口商等不得作 standalone alias／identifier。證據檔：`evidence/user-submissions/2026-08-27-cha-li-wang-moli-longjing-china-origin-thread.png`；SHA-256：`40d6df3b89a835b0f1eae7826a9bcaeaf9412c173e05632045a1ae1783231fba`。
...
- 基隆地檢署 2026-08-24 官方新聞稿仍遮名：飛○科技股份有限公司的陳○傑、C 男（陳○諺）分別為實際負責人、總經理，共同綜理公司事務並經營伺服器買賣。官方指 C 男等 8 人就不法出口高階 AI 伺服器部分涉背信、偽造文書等罪嫌；全案起訴 9 人另包含青○公司資產案的何男，陳○傑因另行通緝不在本次起訴 9 人內。聯合報及自由時報把公司與 C 男橋接為飛虎科技／陳旻諺；聯合報報導檢方對陳旻諺求刑 3 年。程序只能寫遭起訴、檢方求刑，不可寫成法院判刑、有罪或定讞。
- 官方資料記載完成轉售出口 74 台 B300 伺服器，另有 56 台未完成出口；媒體標題使用「走私」，record 採官方「不法出口」及背信／偽造文書罪嫌口徑。刑事程序只歸於自然人，不表示飛虎科技法人遭起訴、判刑或有罪。官方實際負責人完整姓名仍遮蔽，不用公司登記負責人或姓氏補猜；陳○傑只保留在公司卡的遮名管理角色及通緝狀態，不建立完整姓名人物卡。
- 公司官網只直接支持頁首使用 `飛虎科技股份有限公司` 名稱及未公開完整管理名單。另查得的相似現行公司登記名稱與負責人，缺乏不依賴台灣公司稅籍號碼、可重現的直接舊名沿革來源，不能安全橋接為本案公司或管理層；因此不加入公司 aliases 或人物卡。官方來源 title 與 URL 必須採 PDF 原題「基隆地檢偵結不法出口高階伺服器案件，並起訴被告 9 人」及官網直接 href，不自行在題名／路徑插入 `AI`。
- 飛虎公司 searchable fields 僅 `飛虎科技`、`飛虎科技公司`、`飛虎科技股份有限公司`；陳旻諺人物卡僅 `陳旻諺`。不把陳○傑、陳姓實際負責人、總經理、B300、伺服器、輝達、美超微、中國、走私、不法出口、背信、偽造文書、起訴、通緝、內鬼、Threads、媒體名或未橋接的相似公司名稱作 standalone alias／identifier。證據檔：`evidence/user-submissions/2026-08-27-feihu-technology-ai-server-indictment-thread.png`；SHA-256 `5e634a43d738436a83a984eaa69881c2519de550361a5be3fa00a0b722695d48`。

## 2026-08-26 門前隱味牛肉麵／吳皓民：酒駕緩起訴確認後品牌與人物個人避雷

- Record：`wumamii-beefnoodle-owner-dui-deferred-prosecution-personal-20260826`；`personal` / `high`。使用者提供 Threads 截圖，明確要求「查證，真酒駕就避雷」。截圖中的重複指控只作線索；ETtoday 2023-12-06 具名報導直接稱吳皓民為門前隱味牛肉麵老闆，並記載其飲酒後駕車約 2.3 公里、警方測得吐氣酒精濃度每公升 0.77 毫克、依公共危險罪送辦，且其在警詢、偵查均坦承酒駕。聯合報 2023-12-07 由具名記者明載事件日期為 2023-09-28，並交叉確認門前隱味吳姓老闆、同一酒測值、坦承犯行及士林地檢署處分：緩起訴 1 年，處分確定後 8 個月內支付公庫 11 萬 5000 元。使用者設定的條件已成立，因此將品牌及吳皓民列入個人避雷。
- 責任與程序必須分層：酒駕行為與緩起訴處分只歸於自然人吳皓民；不可改寫成法院判刑、有罪確定，亦不可稱門前隱味品牌、任何公司／商號、分店、員工、廣告照片人物、台酒商品或合作品牌是刑事被告或受同一處分。官方網站只支撐品牌名稱與 `wumamii.com.tw` 網域，不支撐酒駕；使用者截圖也不單獨證明酒駕。
- Searchable fields 僅保留門前隱味牛肉麵、門前隱味、WUMAMII BEEFNOODLE、吳皓民與 `wumamii.com.tw`；酒駕、酒駕仔、0.77、公共危險、緩起訴、特斯拉、地點、台酒、麻辣乾拌麵、500 盤、Facebook、Threads、`double_lucky_` 等原因／事件／來源／平台／泛稱不得作 alias／identifier。證據檔：`evidence/user-submissions/2026-08-26-wumamii-beefnoodle-owner-dui-thread.png`；SHA-256：`e74b4030c02776f6b585606dcabf72de067c88f3793e603e90669c3bb445a27a`。
...
- 截圖貼文寫「台南知名飲料店 甜又鮮，原來是草店／我個人是不會再踏進去一步的」；附圖點餐機可辨識一個售價 0 元的選項，使用柯文哲照片並寫「我們選 KP」，旁邊另見「不帥又不完美但較實際」。這能直接支持截圖所示未辨識據點的機台內容及貼文作者的「草店」稱呼，但不能把該稱呼升格為店家、經營者、全體員工或所有據點的正式政黨隸屬，也不能推定政治獻金、競選合作、違法、食安或產品／服務品質問題。
- 甜又鮮官方網站標題並列 `Sweet and Fresh Drinks 甜又鮮`，頁尾列府前路一段與金華路四段兩個台南地址；官方菜單的噴射梅子綠、花蜜檸檬香青茶、水蜜桃青蘋果冰茶、檸檬水蜜桃青茶、獨家多多綠特調等多個品項與截圖機台逐一吻合，足以橋接品牌身分。截圖沒有地址／分店標示，未登入 Threads profile 只見登入牆且公開搜尋未取得原貼永久連結，故拍攝分店未確認，不可宣稱兩個官方列載據點都展示相同內容。
- 搜尋欄位只收 `甜又鮮`、`甜又鮮飲料`、`Sweet and Fresh Drinks`、`sweetandfreshdrinks.com`；不收官方頁尾描述「台南甜又鮮飲料」，也不收草店、小草、柯文哲、KP、我們選 KP、政治、民眾黨、點餐機、台南、飲料店、府前、金華、Threads、發文帳號、產品品項、地址、電話等理由／平台／泛稱。證據檔：`evidence/user-submissions/2026-08-24-sweet-and-fresh-drinks-political-kiosk-thread.png`；SHA-256：`84e03260a651fde6b7dd3df703878c2f367e38c126aa8a07a9281faa7b2ea95d`。
...
- 證據邊界：可忠實記錄使用者對輸入行為的走私判斷，但經濟部官方稿未具名 EXRIDE，因此不可把該判斷擴寫成 EXRIDE 已證實為實際進口、組裝或走私行為人。現有來源也不足以確認七月展示車與八月查扣車是同一輛，或證明 EXRIDE 是 820-RR 的正式授權經銷商、整車販售車行、進口商、車主或組裝者。經濟部官方 2026-08-11 新聞確認新北市涉案營業場所查扣中國大陸重型機車拆件輸入／在臺組裝案件，但未具名 EXRIDE、車款或店家；EXRIDE 官網所列門市位於台北市與桃園市，不可自行把任何門市推定為該新北涉案場所，也不可寫成 EXRIDE 已被裁罰或違法定讞。
...
- 圖片可直接辨識「恆聚未來城」「榮耀完工」「非華廈」「現在買 3 房」「內埔市中心」「送全戶裝潢」及屏東客運；左側女性圖像未見可辨識上衣／肩帶，並以雙臂遮住胸前。只能寫可見的裸身意象及使用者稱之為「裸女」素材，不能確認模特兒實際全裸、拍攝日期、投放期間或誰設計／委託／核准廣告。
- 恆聚建設集團官方建案頁直接列「未來城」、賞屋專線 `08-7790669`，與照片可見的 `08-779066…` 前段相符；頁面並嵌入「未來城-榮耀完工」及完整題名含「恆聚未來城」的恆聚建設頻道影片，因此品牌／建案／照片廣告身分橋接可直接確認。官網首頁另直接連到標題為「恆聚未來城」的 Facebook Page ID `100063667456101`。
- 建築世界以官網 `wggroup.com.tw` 將品牌橋接到「恆聚建設開發股份有限公司」，但這是產業資料而非政府登記；591 則把本案投資建設、營造及企劃銷售均列為居德營建事業股份有限公司。因此本筆不把恆聚建設開發股份有限公司改寫成本案法律上的投資建商，也不把居德營建、屏東客運、模特兒、未知代銷／廣告代理商或其他同名公司納入使用者避雷。
- Searchable fields 僅恆聚建設品牌／集團／產業資料正式公司名、`恆聚未來城`、簡體變體、官方網域、Facebook Page ID 與必要 YouTube 頻道 ID；`未來城`、裸女、裸身、遮胸、性化、物化、噁心、廣告、公車、屏東客運、居德營建、內埔、榮耀完工、非華廈、3 房、送全戶裝潢、電話、YouTube、Facebook 等理由／文案／平台／泛稱不得另作 standalone alias／identifier。證據檔：`evidence/user-submissions/2026-08-22-hengju-future-city-bus-ad.png`；SHA-256 `666a6d34a2ab1b8b2683a97272a1183886fbead0d0c91f49d603f8933e4e0ab8`。

## 2026-08-22 吳慷仁：既有長期中國市場發展名單補入壹心娛樂個別證據

- 既有 Record：`taiwan-entertainers-long-term-mainland-china-market`；`personal` / `medium`。查重確認吳慷仁／吴慷仁／Chris Wu 原已在此名單 aliases，因此本次不另建重複人物卡，只補足吳慷仁個別來源、使用者截圖與證據邊界。
- 吳慷仁本人已驗證 Facebook 原始貼文永久連結可直接讀取，頁面標示 2024-09-30；本人寫「介紹我的新朋友，壹心娛樂」及「我們會一起走這條修練演員的路」，足以確認其公開宣布與中國經紀公司壹心娛樂合作。台視新聞與鏡週刊同日讀回／嵌入相同貼文作交叉來源。NOWnews 2026-08-22 報導仍將他列為壹心娛樂旗下台灣男星，但媒體目前列名不等於已取得完整合約或證明法律上的合約仍有效。
- 使用者截圖中的串文貼文與自由娛樂圖卡把楊天真談中國影視寒冬的「開機率暴跌7成／江山已不在」連到吳慷仁「沒戲拍」。NOWnews 正文實際呈現的是楊天真談中國影視業整體開機率約為前一年 30%、許多演員簽約後仍無法開機，不能改寫成楊天真已證實吳慷仁本人確定無戲可拍；避雷核心只採可確認的 2024 年簽約／加入壹心娛樂及赴中國影視市場發展。
- Searchable fields 沿用既有姓名變體，不新增壹心娛樂、楊天真、沒戲拍、開機率、江山已不在、Threads、串文、Podcast 或其他來源／理由／泛稱。證據檔：`evidence/user-submissions/2026-08-22-wu-kangren-yixin-entertainment-thread-screenshot.png`；SHA-256 `71f4a0c4358dad91ddcf0c6ec6438972b9b0da9ee6451b21418f1f2cd3e43c88`。
...
- 董氏基金會華文戒菸網 2026-08-20 官方董氏快訊以「【台灣拒菸聯盟】家長怒：香港不行、台灣豈能放行？動漫赤裸置入菸品廣告　董氏行文檢舉」為題；4Gamers 同日完整報導明載台灣拒菸聯盟發布新聞稿，董氏基金會接獲家長檢舉、彙整事證後正式行文主管機關要求依法查處，基金會主任並要求儘速依法懲處。報導中直接要求政府下架影片的引言另屬台灣家長守護婦幼權益協會秘書長，不移植為這兩個目標的逐字原話。
- 財團法人董氏基金會 searchable fields 僅正式名稱、`董氏基金會`、`John Tung Foundation`；台灣拒菸聯盟 searchable fields 僅繁／臺字變體。聯盟官方成立頁稱由 119 個民間團體組成，但本次只收聯盟共同倡議實體，不外溢到全部成員；董氏紀錄也不外溢到員工、捐款人、服務使用者或合作團體。證據檔：`evidence/user-submissions/2026-08-20-jtf-taiwan-tobacco-free-alliance-yani-neko-screenshot.png`；SHA-256 `5838ebc942dc11b240f29aa6d5685dca61d10cec7f2c762456146a174bf32962`。

## 2026-08-20 劍道選手蘇郁程：代表中國隊出賽的個人避雷

- Record：`su-yucheng-china-kendo-team-personal-20260820`；`personal` / `high`。使用者明確糾正任務是「避雷」，不是追查戶籍處分；核心理由為蘇郁程代表中國隊參加 2024 年第 19 屆世界劍道錦標賽，以及使用者截圖呈現的第一人稱中國隊認同文字。是否取得中國戶籍／護照、是否遭註銷台灣身分，不是本筆個人避雷的成立門檻。
- 中央社 2024-07-20 引述中華民國劍道協會確認：蘇郁程由中國劍道協會持其廈門長期居住及工作證明向國際總會申請，代表中國出賽；國際劍道總會官方頁確認賽事於義大利米蘭舉行及中國參與男子團體賽。使用者提供的自由時報頁面截圖內嵌一則顯示名稱「蘇郁程」的社群貼文，文字以「我們」稱中國隊並出現「我們的國旗」；未取得原始貼文永久連結，因此只按新聞畫面歸屬，不獨立確認帳號控制權或完整上下文。
- 收錄範圍限蘇郁程本人，不擴及中華民國劍道協會、中國劍道協會、其他選手、教練、賽事或劍道界。searchable fields 僅 `劍道選手蘇郁程`、`蘇郁程`、`苏郁程`；中國、中國隊、台灣、劍道、選手、世界劍道錦標賽、陸委會、國旗、國籍、戶籍、護照、註銷、媒體名與其他理由／來源／泛稱不得作 standalone alias／identifier。證據檔：`evidence/user-submissions/2026-08-20-su-yucheng-china-kendo-team-news-screenshot.png`；SHA-256 `757c25deb1054274b8ab9d121f597531dd6d71bd2d9ad58ac3935fec8e1e15fd`。
...
- 2026-08-17 未登入查核抖音公開頁：顯示名稱「IFBB PRO 王翔」、抖音號 `55794646235`，第一人稱自介直接寫「大家好我是來自中國台灣的IFBB PRO王翔」。Instagram 公開頁 `@0226_wang_ifbbpro` 標題為「IFBB PRO🇹🇼」，描述含「2023 IFBB PRO CARD Men’s Physique」；IFBB Professional League 官方 2026 Huanji Harbin China Pro 成績列 `#14 Siang Wang / Taiwan, China / Place 1`，與使用者截圖中指名王翔及 014 號選手形成身分橋接。IFBB 的 `Taiwan, China` 是賽事欄位，不是本人英文自稱；目前只確認抖音首頁文字，未確認其何時設定、是否在影片／訪談口頭說過，也不延伸成承認任何政治命題、違法、全面赴中發展或奧賽資格。
- 收錄範圍限王翔本人，不擴及 `ding_ggggggggg`、賽事、教練、學生、合作單位或其他同名者。searchable fields 只保留 `健美選手王翔`、`王翔`、`王翔 健美`、`王翔 健美選手`、`IFBB PRO 王翔`、`Siang Wang`、`0226_wang_ifbbpro`、`55794646235`；中國台灣、中國、台灣、健美泛稱、職業賽、冠軍、IG、線下學生、Threads、抖音、FoYes、慕際、Olympia、IFBB 與其他理由／平台／賽事泛稱不得作 standalone alias／identifier。使用者截圖：`evidence/user-submissions/2026-08-17-wang-xiang-bodybuilder-china-taiwan-screenshot.png`，SHA-256 `b44e9f5aacb7b6a7b213475f565859e8a529f93a2c701baf7e0cfe7934ff7dca`；抖音頁面證據：`evidence/user-submissions/2026-08-17-wang-xiang-douyin-profile-china-taiwan.png`，SHA-256 `0d6eb224b4d5bcb4577229bbbf50b5dfc2e0b93d52027c1f84f986abd8db9027`。
...
- 獨立只讀覆核後完成四項收斂：個人提示詞移除入庫快捷語與既有資料狀態；公眾人物重大指控新增「只查核、不以截圖直接發布」例外；驗證與提交合併成單一權威清單；Hermes skill 的 successor／rebrand 重複規則已合併，且與本 repo 衝突時以本 repo 為準。
...
- 截圖頁首可見「財經戰將游智彬」、相對時間「16小時」及公開貼文圖示，影片畫面另有政治相關文字。這只支持截圖可見帳號標示與使用者的個人避開決定；未取得原始貼文／影片永久連結、完整上下文或帳號實際控制人資料，不能確認影片文字所指對象、主張真實性、線下本人身分、政治立場、違法或法律責任。
- 搜尋欄位只收 `財經戰將游智彬`、`游智彬`；不收平台名稱、16小時、票投民進黨、孩子上戰場、親兒在美國、百姓嚐苦果、民進黨、戰場、政治、影片或其他理由／口號／泛稱。證據檔：`evidence/user-submissions/2026-08-14-you-zhibin-finance-general-screenshot.jpeg`；SHA-256 `1960b17e6f3757a47dafdde3b51add745c2621fb1b65129e523af43c5329aa44`。
...
- 食藥署 2026-08-01 官方說明與衛福部關係圖確認：威加受託源春製造、亞世家分裝的 250mL 產品包含永豐餘「在地金花小菓苦茶油」、威加「高仰三苦茶油」、庭茂「庭茂苦茶油」，同批原料共 6 個效期 2028/1/2、2028/2/22、2028/3/17、2028/5/25、2028/6/15、2028/6/22；另有國際機能／江醫師「台灣苦茶油」500mL，效期 2027/12/25 已檢出，2028/5/24、599瓶尚未出貨而預防性管制，合計 4個產品品牌、8批效期。
- 可直接對應的檢出：在地金花小菓 2028/5/25 為 2.9 μg/kg；高仰三 2028/6/15、2028/6/22 為 2.6、2.4 μg/kg；台灣苦茶油 2027/12/25 為 2.6 μg/kg，限量均為 2.0 μg/kg。官方未將 2028/1/2、2028/2/22、2028/3/17 逐一對應到三個品牌，不得自行配對。
- 嘉義縣衛生局已要求源春停工；源春自製油品庫存150公斤就地保管、停止販售。官方稱苦茶籽來源尚無明確佐證；石崇良所述「疑似中國進口」仍是調查方向，不得寫成已證實中國原料、違法進口、故意摻用或超標因果已確定。
- 搜尋欄位只收源春製油廠、3個明確產品／品牌名稱、國際機能／江醫師＋容量／效期的限定識別詞、必要公司—產品組合與已知產品＋效期；苯駢芘、食安、下架、回收、停工、疑似中國、原料來源、嘉義、檢調等不作 standalone alias／identifier。2026-08-31後應依官方調查、製程改善及新檢驗結果複查，無新進展則降為歷史警示。
...
- 原公開串 `kk__ing19/DbecuR-H2R3` 於 2026-08-01 發布，文字與附圖呈現麵線在巷道路面、水溝蓋周邊架設曬製的衛生觀感疑慮。公開帳號 `ivy.wn24` 同日另發 `Dbe-8QIElGp`，自稱代表家裡回應「蘆洲中正路手工麵線的曬麵環境」，稱自家爺爺奶奶多年純手工製作、落地或接觸非乾淨區域者會清理不販售，並表示理解食品衛生疑慮、已刪除原推廣留言，在改善前不適合大力推廣，未來會考慮更完善的遮蔽防護。後續說明提供了帳號—家庭麵線活動—爭議照片的公開橋接，但不證明改善已完成。
- 口徑：只可說使用者依公開照片與當事帳號後續說明，將該「蘆洲中正路手工麵線」列個人避買。未取得主管機關稽查／裁罰、污染檢驗、正式店名／品牌或食品業者資料，不可寫成違規、裁罰、全部麵線污染、落地麵線仍販售、廢氣危害已經檢驗證實，或辨識帳號持有人／長輩真實身分。
- 搜尋欄位僅保留 `蘆洲中正路手工麵線` 與公開帳號 `ivy.wn24`。截圖雖顯示精確門牌，但疑似家庭製作地址且沒有正式店名／品牌橋接，不保存、不作 identifier；`Ivy Wu`、來源帳號、水溝蓋麵線、曬麵、食品衛生、廢氣、機車、孫女、爺爺奶奶、遮蔽設施、Threads 等也不得作 searchable fields。
...
- 新浪轉載《石家莊日報》2009-04-08 與中國經濟網 2009-04-07 交叉確認：君樂寶 2000 年引進三鹿品牌及部分資金，三鹿破產時持有君樂寶 16.97% 股權，之後由君樂寶股東以 2,500 萬元回購；前者同時稱君樂寶長期為獨立法人、獨立經營。不可寫成君樂寶是三鹿改名、三鹿目前仍持股，或兩家公司是同一實體。
- 使用者截圖只作查核線索；本輪沒有可靠來源證明 2019 年才上市的悅鮮活涉及 2008 年三聚氰胺檢出、毒奶粉、腎衰竭或腎結石事件。這些主張不得作 searchable fields 或事實定論。
- 查詢只讓君樂寶／君乐宝、君樂寶乳業、JUNLEBAO／Junlebao、悅鮮活／悦鲜活與完整鮮牛奶品牌名命中。`三鹿`、`毒奶粉`、`三聚氰胺`、`腎結石`、`腎衰竭`、`中國人都不敢買`與 `2008` 均不得命中新紀錄。重生後 216 筆；目標 12 checks、全量 10 checks、Node 12 tests 均 PASS，warnings/errors = 0，重生雜湊一致。

## 2026-07-27 木崗高品質雞蛋：既有味全全品牌避雷補入匿名員工截圖線索

- Existing record: `weichuan-foods`；不另建重複卡。`木崗高品質雞蛋` 原已列為味全商品線，本次補 `木崗雞蛋` 查詢別名，使用者指定木崗雞蛋全商品線個人避買。
- 使用者提供 Threads 截圖可見帳號 `jax780824`、相對時間 19 小時與木崗高品質雞蛋包裝；發文者自稱曾任洗選蛋工廠員工、勸勿購買並稱工廠已搬遷。截圖未提供原貼 permalink、工廠名稱、具體作業問題、官方資料或可獨立核驗證據，因此只作 `personal` 個人避買補充，不確認匿名身分、食安、違法或搬遷後現況。
- 味全美好食光官方商城以「木崗」搜尋可直接確認白蛋與冷藏動福紅殼蛋等商品，足以支撐木崗是味全商城商品線；這不驗證匿名貼文內容。帳號、雞蛋泛稱、洗選蛋、工廠、頂新與原因詞不得作 searchable fields。

## 2026-07-25 VOLA／維菈中國原產服飾標籤：限於標籤可確認商品的個人避買

## 2026-07-27 虎牌粉絲中國製標籤：使用者指定虎牌全品牌避雷

- Record: `tiger-rice-noodles-china-origin-whole-brand-personal`；`personal` / `high`。使用者提供 Threads 截圖，包裝背標可讀到虎牌粉絲、原產地中國與虎牌日進食品股份有限公司名稱。
- 使用者明確修正採買範圍為「不用說部分產品，直接避雷」；因此虎牌直接以全品牌個人避買收錄，查詢虎牌、虎牌米粉、虎牌粉絲與虎牌日進食品均應命中。
- 事實邊界：直接標籤證據只確認虎牌粉絲為中國製；全品牌避雷是使用者個人採買決策，不代表每個 SKU 均已逐一驗證為中國製，亦不可延伸為食安、違法、禁售、國資或中共控制。

## 2026-07-27 POLYWELL 延長線中國製標籤：使用者指定全品牌避雷

- Record: `polywell-taiwan-origin-claim-china-label-whole-brand-personal`；`personal` / `high`。使用者提供 Threads 截圖可見 POLYWELL 2P中繼型電源延長線（單插）、型號 `PW15-T05-A046`、製造商寶利威爾企業股份有限公司與標籤「原產地：中國」。
- 貼文稱購物／官方網站與原包裝均標示台灣、實物另貼中國產地標籤；本專案未直接讀回各網站或包裝，所以僅記為使用者提供的截圖線索，不可寫成已確認虛偽標示、欺騙或違法。
- 依使用者剛剛確立的規則，POLYWELL／寶利威爾直接全品牌個人避買；標籤直接確認只限該型號為中國製，不代表所有 SKU 均逐一驗證為中國製，亦不可延伸為食安、安全、禁售、國資或中共控制。

## 2026-07-27 烏克蘭人柯羅：截圖歸屬的跨性別貶抑言論個人避開

- Record: `ukrainian-koro-gender-slur-screenshot-personal-20260727`；`personal` / `low`。使用者提供 Threads 截圖可見 `cutcrap_` 貼文（畫面標示 13 小時前）將兩段文字歸屬於「烏克蘭人柯羅」，其中一段含對苗博雅的跨性別貶抑措辭。
- 截圖沒有原作者帳號、永久連結或可獨立核對的時間；Google／Bing／Yahoo／Mojeek 的公開搜尋本輪受驗證、暫時故障或自動查詢封鎖，未取得身分或原文交叉來源。因此限於使用者依截圖指定的個人避開，不確認原文、真人、國籍或言論的法律定性。
- **嚴格排除**：截圖文字對偷拍、性觸與「前科」的指控沒有原始案件來源或身分橋接，完全不入庫、不轉述、不作搜尋理由；同樣不將 `cutcrap_`、苗博雅、中文怪物、政治關鍵詞或跨性別等脈絡詞做成 searchable fields。
...
- 新北市衛生局 2026-07-22 公告可直接對應兩款產品、批號與販售通路；其 2026-07-23 直接公告明確稱**本次連淨苦茶籽原料由中國輸入**，並指出問題批次已流入統一生機等通路。中央社報導僅作交叉轉述，records 以衛生局一手頁為主。
- 使用者明示個人採買標準：同一製造端曾有一次可靠的中國原料紀錄，即足以避開其苦茶油產品線。因此新增 `aconpure-camellia-oil-product-line-china-seed-history-personal`（連淨苦茶油產品線，`personal` / `medium`）。這是使用者的風控範圍，不是官方對所有產品或未來供應的原料判定。
- 事實邊界：官方只直接確認上述兩個具名批次的**中國苦茶籽原料**，不是中國製成品；不擴及連淨其他食品品類。統一生機在官方資料中是該批成品通路／品牌，不足以擴及統一生機全品牌。苯駢芘事件也不能推定原料必然違法或不安全。
- 目前台灣 PChome 個別連淨商品頁會標示台灣原產，但沒有逐批號橋接能力；不以該通路標示覆蓋或否定新北衛生局對本次批次原料來源的說明。
- 產品線卡與兩張批次卡已重生為 211 筆資料；全量 validator PASS（10 checks、warnings/errors = 0）。產品線目標驗證 PASS（13 checks）：`連淨苦茶油`、`連淨綠色科技 苦茶油`與 `連淨` 均可命中產品線卡；`統一生機`、`苯駢芘`、`回收`不命中該產品線卡，避免將通路或事件文字擴大成連淨產品線搜尋理由。

## 2026-07-23 查詢頁初始空白：空白欄按 Enter 才顯示全部

- `app.js` 載入 `brands.json` 後仍會完成正規化與篩選選項建立，但初始結果區不建立任何卡片；顯示「結果計數：尚未查詢」與操作提示。
- 輸入關鍵字會即時顯示匹配卡片；選取任一篩選條件也會顯示匹配卡片；清空輸入則回到初始空白。只有搜尋欄空白時按 Enter，才明確顯示全部結果。
- 新增 `query-display-state.mjs` 的純函式 `shouldRenderResults()`，以及 `tests/query-display-state.test.mjs`。TDD 紅燈為缺少函式；綠燈驗證初始空白、文字查詢、空白 Enter、空白搭配篩選四種狀態。
- 本機瀏覽器驗收：初始 0 張卡片；查詢何勝豐為 1 張；清空回到 0 張；空白 Enter 為 208 張。靜態站沒有 `package.json`、Tauri 設定或既有版本欄位，不能做不存在的版本遞增。

## 2026-07-23 劉育成／陳榮昌／何勝豐：公開來源重建，取代未查證群組圖卡

- 使用者指出先前不可只依社群圖卡入庫；原本的三人 screenshot-only 群組已以 commit `e24ec8d` 下架。重新入庫前，分別以法院、監察院、學校、議會與具名媒體原始頁面核對身分、角色與程序，三人不可再共用一筆模糊群組紀錄。
- `liu-yucheng-da-an-primary-second-instance-202607`：`confirmed` / `high`。臺中高分院 113年度侵上訴字第85號 2026-07-15 駁回劉育成上訴，維持原審就加重強制性交、加重強制猥褻及成年人故意對兒童性騷擾等罪所定應執行15年8月。二審部分仍可上訴，本專案未取得全案確定資料；身分限於竹山鎮大鞍國小前校長，不能誤稱竹山國小。
- `chen-rongchang-mandatory-reporting-personal-202607`：`personal` / `medium`。監察院遮名報告記載延平國小陳姓輔導主任受理、訪談及留存學生投訴而未依法通報；經官方竹山國小歷任校長頁與《報導者》職務—學校—時間鏈交叉，與陳榮昌相符。他在2025年7月退休；不可寫成劉育成刑案被告、共犯、刑事判決或現任校長，也不可把未具名後續處分直接歸屬他。
- `he-shengfeng-public-reporting-personal-202607`：`personal` / `low`。官方僅確認有未具名地方民代參與協調／施壓情節，未具名何勝豐；《報導者》將此連結歸屬受訪者說法，自由時報保存何勝豐承認與劉熟識且否認包庇／施壓的回應。不可寫成何勝豐包庇、施壓、共犯、涉案、被調查、被起訴或被處分。
- 三筆搜尋鍵均只保留完整姓名。每筆全量 validator 與目標正查、敏感詞 `--not-expect` 均 PASS，`warnings: 0; errors: 0`。
...
- 可採事實：司法院可查臺灣高等法院 108 年度金上重訴字第 35 號（證券交易法等）與一審脈絡；自由時報、太報於 2024-09-12 均報導最高法院駁回上訴，朱國榮就內線交易與操縱龍邦股價相關案件判刑 16 年確定。
- 嚴格排除：截圖提及的澳門舊案、1980／1982、殺人、通緝、偷渡、身分證、國籍／身分、朱子昭等未取得一手司法或官方身分橋接的敘事皆不可寫成事實；更不可歸責泰山企業。
- 泰山公司邊界：官方 114 年年報截至 2026-03-31 列龍邦 38.34%、保勝 11.66%，合計 50.00%，保勝由龍邦 100% 持有，並有保勝法人代表董事；該年報未列朱國榮為泰山董事、法人代表或表內法人股東。因此不因這張截圖新建泰山公司人物背景紀錄，既有中聯油脂下游／預防下架事件亦與本案分開。
- 查詢僅 `朱國榮` 可命中；泰山、1218、龍邦、保勝、國寶集團、澳門、1980、1982、殺人、通緝、偷渡、身分證、中國人、朱子昭、foodiepapa.go、frenk223311、台灣新聞網、Threads 不可命中。外部報告：`D:/AI_workspace/.hermes/profiles/amagi-line/cache/reports/taishan-zhu-guorong-source-report-20260722.md`。
...
- 口徑：經濟部官方資料可直接確認楊智堯為嘉達的登記負責人，這項公司—職務關係可保留；可將「公告以配合香港《維護國家安全法》為由」完整歸屬於媒體報導及業者受訪。不可寫成公司受中國／香港政府指示、確有配合中國政府審查、違法或所有服務都受限。第二張 Google／AI 摘要中的親屬／刑案內容未取得可靠原始來源與身分橋接，完全不可寫入公司紀錄或回覆。
- 查詢：僅 `嘉達國際物流有限公司`、`嘉達國際物流`、`JAGUAR LOGISTICS`、`JAGUAR LOGISTICS CO., LTD.`、`jaguargp.com` 可命中；登記負責人姓名只保留在來源敘事，不加入 alias／identifier。香港、國安法、維護國家安全法、書籍、拒運、禁書、中國、配合中國、ftvnews、Threads 不可命中。外部報告：`D:/AI_workspace/.hermes/profiles/amagi-line/cache/reports/jiada-logistics-source-report-20260722.md`；4 positive／4 expect／11 not-expect 均 PASS，warnings/errors 為 0。
...
- 公開來源：中央社可確認馬呈豪於 2024-11 接任花蓮縣原住民行政處處長；公視可確認義煮團車輛遭警方攔下／縣府後稱表明用途可放行，以及豐年節現場舉牌者被警方帶離並有警方說法。這些來源均**不支持**馬呈豪下令、作成攔阻／帶離決策或應負責。
- 口徑：只可說使用者依截圖及有限公開脈絡指定個人避開；不可寫成他趕走義煮團、下令逮捕／帶離、違法、官方認定或法律責任。可查僅 `馬呈豪`、`马呈豪`；原民處長、花蓮、光復、義煮團、豐年節、舉牌、逮捕、警察、來源帳號與 Threads 均不可命中此筆。
- 外部來源報告：`D:/AI_workspace/.hermes/profiles/amagi-line/cache/reports/ma-chenghao-screenshot-source-report-20260722.md`；目標驗證的 2 個正向、2 個 expect、11 個 not-expect 均 PASS，warnings/errors 為 0。

## 2026-07-21 店家／餐飲公開背景查核：擴大掃描與證據界線

- 店家背景查核不可只停在官方登記、食安／衛生裁罰與裁判書；在可精確識別店名／地址／公開負責人職務的前提下，也要掃描公開負責人與可直接橋接的關聯店家、登記異動／前身線索、可信新聞、勞資／消費爭議，以及可直接歸屬的公開評論或社群線索。
- 名稱、地址、負責人姓名或相鄰店面只可作為待查線索；沒有可重現的公開橋接時，不得推定改名、遷址、頂讓、共同經營、同一自然人或同一商業主體。不得查或保存台灣公司稅籍號碼、私人地址、電話、車牌或其他非必要個資。
- 輸出時分層：A＝可由獨立可信來源交叉核驗；B＝單一可信公開報導或公開原始貼文；C＝尚未驗證的消費者／社群線索。B／C 只能陳述來源和限制，不能寫成違規、責任或事實已成立。
- 沒有命中時，固定說「本輪公開掃描未發現可直接歸屬的訊號」並說明查核範圍；不得寫成沒有爭議、沒有問題或已通過稽查。公開負面評論可列作輔助判斷，但必須標示其證據層級與無法獨立驗證的限制。
...
- 官方事實：最初由臺南市衛生局通報明好企業社生產的農耕牌濁水炊粉（有效日期 2028-01-05）；新竹市衛生局 2026-07-18 公告後續列 4 品項／7 個有效日期炊粉檢出甲醛，並命列明批次下架回收、同類產品停產及限期改善；2026-07-20 公告補充首批 3 件與第二批 3 件送驗產品均檢出。現場未查獲違法添加物，官方明示仍須稽查釐清是否人為添加。
...
## 2026-07-30 食力 foodNEXT／食育力城市大調查相關個人避開
...
- 工商時報2019年魏應充專訪支撐灃食與頂新和德公益專款信託／三大基金會關係；《食力》2024、2025官方專題頁曾列灃食為調查合作單位，但2026官方7單位不含灃食。
- 最高法院2022-07-29新聞稿的油案責任只歸於頂新製油及判決所列被告，不可外溢成《食力》、厚策思維、童儀展、灃食或7個合作單位共同製造劣油、共犯、受頂新控制、受其贊助或負法律責任。
- 三筆皆採 `status: personal`；2026官方7單位為 `confidence: high`，食力／厚策／童儀展與灃食關係鏈為 `medium`。
- 查詢設計：第一筆保留《食力 foodNEXT》、厚策思維、厚策思維有限公司、童儀展與 `foodnext.net`；合作群組僅保留7個正式單位名稱；灃食筆僅保留正式名稱與「灃食基金會」。不要把頂新、魏應充、味全、食育力、五星城市、毒油、食安、主辦方、合作單位、基金會或協會等關係／原因／泛稱作 alias 或 identifier。

## 2026-07-30 鮮榨柳橙汁（中國柳橙果肉）實體標籤個人避買

- Record: `yolu-jamei-fresh-orange-juice-china-pulp-personal`
- 使用者提供實體瓶身照片；標籤可直接讀到品名「鮮榨柳橙汁」、成分「柳橙原汁（台灣）、柳橙果肉（中國）」、內容量300毫升、悠旅生活事業股份有限公司委託及佳美食品工業股份有限公司製造。
- 依使用者對中國製食品／中國食品原料的採買偏好，採 `status: personal`、`confidence: high` 的 SKU 級紀錄；searchable fields 只保留品名及兩個公司全名。
- 照片未拍到正面品牌，不據此認定所屬通路／品牌，也不擴張成悠旅生活或佳美食品所有商品皆含中國原料、中國製成品、食安不合格、違法或主管機關裁罰。
- 本機查重未見品名、悠旅生活或佳美食品既有紀錄；「星巴克」另有既有群組命中，但本張照片本身未顯示品牌，故不把星巴克作本筆 alias。
- 不查詢、不保存台灣公司稅籍號碼；標籤地址與客服資訊不作 searchable fields。
...
## 2026-08-07 孫健豪／孫安佐／Edward Sun 人物案件截圖補錄

- Record：`sun-jianhao-sun-an-zuo-public-cases-screenshot-personal-20260807`；使用者以維基百科人物頁截圖指定將孫健豪／孫安佐／Edward Sun 列入 `personal`；只收自然人，不把案件責任外溢到孫鵬、狄鶯、頻道、合作人物或其他法人。
- 證據檔：`evidence/user-submissions/2026-08-07-sun-jianhao-screenshot.png`；SHA-256：`f36eac270a6e88dfe35153fe582a13969e79fce739e452c3603dfaf2f95ced29`。
- 美國核心程序以美國司法部與 ICE 官方頁核對：An-Tso Sun 亦名 Edward Sun；2018 年就聯邦外國人非法持有彈藥罪認罪，ICE 頁記載判刑服刑期滿後於 2018-12-11 遣返台灣。美國司法部頁也記載其在賓州地方案件就 terroristic threats 認罪；口徑保留為官方所載認罪／判刑／遣返，不延伸為台灣法律定論。
- 台灣程序以 ETtoday 與中央社分層：ETtoday 2022-01-26 報導 2020 年起訴案由士林地院宣告公訴不受理、判決理由當時待公布；中央社 2026-07-30 報導其已改名孫健豪，遭起訴後首次開庭，僅承認持有模擬槍、其餘犯行否認，案件不是有罪定讞。
- 截圖另列泰國、烏克蘭、拳願評審／參賽等敘述，未全部取得獨立可靠來源，不作本專案已查證事實；搜尋欄位只收完整姓名與可核對英文名，不收恐攻、槍、火槍、泰國、烏克蘭、拳願、起訴、交保或其他案件／理由泛稱。

## 2026-08-09 新視界眼鏡：店面辨識不確定的簡體宣傳文字截圖個人避買

- Record：`xinshijie-eyewear-simplified-sign-screenshot-personal-20260809`；`personal` / `low`。使用者提供 Threads 截圖並明確指定將使用者辨識的「新視界眼鏡／新視界驗光所」列入個人避買。
- 截圖可見眼鏡店宣傳吊牌與部分簡體中文用字，包含「贴心的眼镜管家」「专业技师 精准验光」等；完整店名未清楚露出，下方店招失焦且被遮住。Google Maps 公開搜尋結果可見同名「新視界眼鏡／新視界驗光所」條目，但不能把截圖對應到任何特定分店。
...
## 2026-08-16 中華大悲法藏佛教會：保育放流／宗教功德方案個人避雷

- Record：`zhonghua-dabei-fazang-buddhist-association-life-release-personal-20260816`；`personal` / `medium`。使用者要求將「觀音山中華大悲法藏佛教會」列入個人避雷，理由是其認為對方是「一群詐騙」且「放生的意思都搞不懂」；紀錄將此保留為使用者的個人信任與理念疑慮，不改寫成已證實刑事事實。
- 內政部人民團體數位櫃台以「中華大悲法藏佛教會」查得 1 筆，團體類型為社會團體、狀態為已立案；官方網站使用「觀音山」品牌發布佛法、法會、慈善與保育放流資訊。這些資料支持組織身分橋接，不支持詐騙或放流違法定性。
- `https://www.fazang.org/liferelease/` 的官方方案同時使用生態保育與宗教功德語言：稱與政府機關及專業機構合作，列物種與預計水域／時段，也寫「放生就是延壽」、佛法加持、息災延壽祛病法會、除障祿位與超薦蓮位；頁面列出 NT$1,000／3,000／5,000／10,000 登記金額，說明款項由本會統籌運用、未指定用途匯款七日內未補填資料即作護持道場弘法用途，並稱不公布精確放流日期、活動完成後才在官網公布訊息。可記為使用者對理念、宗教功德包裝、透明度與用途安排的疑慮，不可寫成捐款挪用、非法放流、外來種危害、虛偽宣傳或違法。
- 官方「反詐騙聲明」內容是提醒有人冒用觀音山／龍德上師名義索取個資、帳戶資料或捐款；這是本會自我聲明，不是本會涉詐或未涉詐的司法認定。本輪公開查核未找到可直接核實該會涉詐的法院判決、主管機關裁處或具名可靠媒體報導；後續若要提高信心，應查逐場放流許可／申請、物種來源與數量、合作單位、活動後公告、捐款／財務揭露及主管機關監督資料。
- 搜尋欄位只保留 `中華大悲法藏佛教會`、`觀音山中華大悲法藏佛教會`、`觀音山 中華大悲法藏佛教會` 與 `fazang.org`；不把放生、保育放流、詐騙、龍德上師、法會、延壽、除障祿位、超薦、捐款、物種、地址、電話、銀行帳號或其他理由／脈絡詞放入 aliases／identifiers。收錄範圍限該法人／官方放流方案，不自動擴及龍德上師、關聯頻道、其他法會、合作單位或其他宗教團體。

## 2026-08-17 觀音山／中華大悲法藏佛教會：人物與放流成效深入查核

- 新增 records：`religious-public-figures-personal.mjs`、`religious-release-outcomes-personal.mjs`；索引加入 5 名 A／B 級直接關聯人物及 1 筆方案成效資訊缺口紀錄。
- 龍德嚴淨仁波切（龍德上師）：官方頁面及保育放流紀實支持其為觀音山／中華大悲法藏佛教會住持與方案宗教帶領者；不得把住持改寫成內政部登記的法人負責人、理監事或海域放流權責人員。
- 林愛龍：海漁基金會執行長、2024 合作意向書外部合作方；謝恆毅：水產試驗所澎湖海洋生物研究中心主任、合作計畫簽署／技術代表；方祥權：澎湖科技大學副教授、合作介紹及生態說明關聯；張永州：海漁基金會創新企劃組組長、在佛教會開設海域放流權責人員訓練的講師。四人均不是因此成為佛教會成員，也不因合作對尚未核實的死亡結果負個人責任。
- 陳高樑、陳晶卉及其他地方官員／貴賓只確認為特定活動見證或出席者；官方人物頁提及的傳承人物沒有方案職務橋接；兩類均不建立個人避雷 record，避免把同場／見證誤寫成組織隸屬。
- 官方紀實與漁業署平台可核對多場活動日期、地點、物種及申報／登錄數量；平台名稱變體查詢原始命中 166 列、完整列值去重 157 列。申報／登錄量不是存活量，也不能由總量推算死亡量。
- 官方頁面稱會依物種與棲地規劃、持續追蹤、提高存活率，成果記者會寫「放生之後的水族活得相當好」，但截至查核日未取得逐場存活率、死亡數、追蹤期間、樣本分母、標記／回捕結果或原始研究表。這些保留為官方自述，不得改寫成所有個體存活或存活率很高。
- 漁業署 2023 全臺放流效益研究所述黃錫鯛約 40%、嘉鱲約 50%野外捕獲個體源自放流種苗，是全臺計畫層級的捕獲來源比例／間接成效，不能套用為觀音山任一場的存活率。
- 本輪未取得可獨立核實的「死一堆」具體活動、死亡數、原始影像或主管機關紀錄；使用者主張保留為尚未獨立核實，不寫成大量死亡、動物虐待、行政違規或刑事責任。查不到死亡證據也不等於證明全部存活。
- 後續若要提高查核信心，優先索取／查找逐場放流許可、種苗來源與檢疫、運輸紀錄、精確座標、現場原檔，以及至少數月的活存／族群監測報告；不得將一般青灣棲地研究或一般放流規範直接套成該會違規證據。

## 2026-08-24 食藥署醃漬蔬菜稽查 5 家裁罰業者個人避雷

- 新增 5 筆公司／業者級 `personal` / `high` 紀錄：旭發食品股份有限公司、典韓實業有限公司、堡晟興業有限公司、協發行國際食品有限公司、芭樂家泡菜館。使用者看到新聞後明確要求將有問題的廠商列入避雷，因此避雷範圍依其指示落在具名業者；不延伸到其他受稽查但合格的業者、零售通路或未有身分橋接的產品／品牌。
...
## 2026-08-28 廖致翔醫師使用者指定個人避雷

- Record：`liao-zhixiang-doctor-user-directed-personal-20260828`；`personal` / `high`。使用者只要求「廖致翔醫生加到避雷」，未提供避雷原因，因此採最小範圍收錄，不自行補寫任何爭議。
...
## 2026-08-31 姚淑文／臺北市社會局長女童安置爭議個人避雷

- Record：`yao-shuwen-taipei-social-affairs-child-protection-remarks-personal-20260831`；`personal` / `high`。使用者明確要求將姚淑文列入個人避雷，並以「有夠噁心」表達對本次事件處理／回應的強烈反感。
- 身分橋接：臺北市政府社會局官方局長簡介列姓名姚淑文、職稱局長、任職單位臺北市政府社會局；只用於核對現職與避免同名誤收。
- 爭議背景：中央社 2026-08-26 具名報導記載，議員指稱 10 歲女童在家疑遭性猥褻、通報後約 240 天仍未安置；社會局回應稱持續訪視、女童曾表達不願安置，並已啟動司法安置程序。NOWnews 2026-08-28 具名報導記載，姚淑文先前以女童表達不想到機構及其後未再發生猥褻回應，質詢現場又被收音說「那是事實」及「那為什麼你要召開記者會跟媒體」；許淑華批評這類說法把責任推給女童並造成二次傷害。
- 證據邊界：「二次傷害」是議員批評及使用者觀感；現有資料不等於法院、監察院或主管機關已認定姚淑文失職、違法、虐待兒童或須負法律責任。社會局的「女童曾表達不願安置」是官方說法，不可改寫成女童應自行負責。
- searchable fields 只保留完整姓名「姚淑文」；不收職稱、機關、議員、市長、女童、10 歲、240 天、猥褻、安置、二次傷害、噁心、記者會、社工或過去任職組織。責任範圍限姚淑文本人，不擴及社會局基層社工、其他市府人員或她過去任職組織。

## 2026-09-01 大白兔／White Rabbit 歷史食安查核與全品牌個人避買

- Record：`white-rabbit-candy-china-brand-historical-formaldehyde-melamine-personal-20260901`；`personal` / `high`。大白兔為源自上海的中國食品品牌；依使用者「中國製食品／中國食品品牌直接避買」規則，採大白兔／White Rabbit 全品牌個人避買。這是個人採買政策，不等於所有現售商品均已逐批確認不安全。
- 2007 年甲醛事件必須保留地區與樣本差異：印尼食品藥品監督管理局公共警告稱抽驗 39 項中國進口食品有 7 項檢出甲醛，列名 White Rabbit Creamy Candy／White Rabbit Candy 並封存待銷毀；新加坡 AVA 同年抽驗大白兔則只檢出微量甲醛，依 WHO 每日可耐受量判定正常食用不構成健康風險，且稱沒有證據顯示作為防腐劑添加。不可寫成所有國家、所有批次或現售大白兔都含違法添加甲醛。
- 2008 年三聚氰胺事件有官方支持：香港食物安全中心在 454 克大白兔奶糖樣本檢出 16 ppm，超過當時 2.5 ppm 上限，要求停止販售並由進口商回收；美國 FDA 保存的 QFCO 廠商公告亦記載 White Rabbit Candy 因三聚氰胺污染召回。這些均是歷史抽驗與召回，不得延伸為現售商品仍污染。
- 現行禁售邊界：CNA 2026-06-17 報導 White Rabbit 官方區域經銷商在新加坡設快閃店並販售多種口味奶糖，足以反證「2026 年新加坡仍全面禁售」；本次未找到足以證明 2026 年仍有多國全面禁售的主管機關資料。對外應說「2007／2008 年曾有部分國家或地區封存、停售、回收」，不可說成目前仍多國禁售。
- 證據檔與 SHA-256：`evidence/user-submissions/2026-09-01-white-rabbit-candy-formaldehyde-melamine-thread.png`（`70cdb9088e6b383285416eec222520d63041c1c8e4cca9b42d692602f2c64974`）。
- searchable fields 只保留「大白兔」「大白兔奶糖」「大白兔糖」「White Rabbit」「White Rabbit Candy」「White Rabbit Creamy Candy」；不收奶糖、糖果、甲醛、三聚氰胺、中國、上海、禁售、下架、召回、Threads、帳號名、主管機關或來源國作 standalone alias／identifier。
