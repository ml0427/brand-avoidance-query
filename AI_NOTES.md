...
- Records：`feihu-technology-ai-server-illegal-export-management-personal-20260827`、`chen-minyan-feihu-technology-ai-server-indictment-personal-20260827`、`wu-zunhuang-feihu-intelligence-registered-responsible-personal-20260827`；皆為 `personal` / `high`。使用者提供 Threads／自由時報畫面，要求找出截圖主體飛虎科技的管理層並全數加入避雷；因此建立公司卡，並為可完整具名的總經理陳旻諺、現任登記負責人吳尊皇分別建立人物卡。
...
- 官方資料記載完成轉售出口 74 台 B300 伺服器，另有 56 台未完成出口；媒體標題使用「走私」，record 採官方「不法出口」及背信／偽造文書罪嫌口徑。刑事程序只歸於自然人，不表示飛虎科技法人遭起訴、判刑或有罪。官方實際負責人完整姓名仍遮蔽，不用現任公司登記負責人或姓氏補猜；陳○傑只保留在公司卡的遮名管理角色及通緝狀態，不建立完整姓名人物卡。
- 經濟部現行資料列該登記主體已於 2026-07-03 變更為 `飛虎智能股份有限公司`，現任登記負責人為吳尊皇；官網仍使用舊名 `飛虎科技股份有限公司`。吳尊皇因使用者指定現任公開可確認管理層而建立人物卡，但沒有來源把他橋接為 B300 案被告、知情者或涉案者；不可把「登記負責人」改寫成董事長、總經理或實際負責人。歷史登記代表人吳旻峻僅見於已過時的第三方鏡像，且不是現任角色，未加入人物避雷。
- 飛虎公司 searchable fields 僅 `飛虎科技`、`飛虎科技公司`、`飛虎科技股份有限公司`、`飛虎智能`、`飛虎智能股份有限公司`；陳旻諺及吳尊皇人物卡分別僅 `陳旻諺`、`吳尊皇`。不把陳○傑、陳姓實際負責人、總經理、登記負責人、B300、伺服器、輝達、美超微、中國、走私、不法出口、背信、偽造文書、起訴、通緝、內鬼、Threads 或媒體名作 standalone alias／identifier。證據檔：`evidence/user-submissions/2026-08-27-feihu-technology-ai-server-indictment-thread.png`；SHA-256 `5e634a43d738436a83a984eaa69881c2519de550361a5be3fa00a0b722695d48`。
