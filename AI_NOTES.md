...
## 2026-09-04 大樹藥局淡水新春店／新春藥局／陳長昇：疑似投藥案特定門市與個人避雷

- Record：`great-tree-tamsui-xinchun-branch-chen-changsheng-suspected-drugging-personal-20260904`；`personal` / `medium`。使用者先提供淡水新春街藥局女大生疑遭投藥的新聞／社群截圖，後續在取得候選店址與公開資料所列姓名的交叉查核結果後，明確要求把「大樹藥局－淡水新春店」與「陳長昇」加入避雷。因此本筆只收錄特定門市／機構與公開資料所列負責人，不擴及大樹藥局整體、其他門市、總公司、加盟體系、員工或合作對象，也不以未證實的中資說法作理由。
- 中央社引述淡水分局說明：女大生在淡水新春街某藥局擔任藥師助理，2026-08-26飲用私人水壺內的水後出現頭暈、心跳加快與意識模糊，液體初篩呈BZD陽性；警方8月29日持搜索票搜索，發現50歲陳姓負責人下藥影像，案件依違反毒品危害防制條例函送士林地檢署。ETtoday具名報導可交叉確認主要程序，並記載女大生另控訴性騷擾；性騷擾目前只是當事人指控。警方、檢方與媒體均未直接公布店名、門牌或完整姓名，案件也仍在偵辦；不得寫成陳長昇被官方具名、已起訴、已判決有罪或定讞，BZD初篩也不得改寫成FM2正式鑑定。
- 身分橋接：大樹官方門市頁列「淡水新春」於新北市淡水區新春街189號；Google Maps同址公開店面照片與新聞畫面在玻璃門、右側深灰牆、地面方磚、坡道扶手及相鄰店面配置上高度吻合；中華黃頁長照機構基本資料頁把同址機構列為「新春藥局」、機構負責人陳長昇，並註明詳細資訊以政府資料開放平台為準。這是公開資料與固定建築特徵的高度推定，不是警方／檢方直接具名，也不能單獨證明該人就是新聞中的陳姓男子。
- Searchable fields僅保留特定門市名稱變體、新春藥局、陳長昇姓名變體與完整公開店址；「大樹藥局」單獨不作alias，但因完整分店名稱包含該字串，搜尋大樹藥局仍可能命中特定分店卡，卡片必須清楚顯示單店範圍。藥局、淡水、新春街、女大生、陳男、老闆、負責人、藥師、下藥、FM2、BZD、毒品、性騷擾、斷片、警方、檢方、媒體名稱、地址片段及其他理由／泛稱不得作standalone alias／identifier。
- 證據檔：`evidence/user-submissions/2026-09-04-tamsui-xinchun-pharmacy-suspected-drugging-news-thread.png`；SHA-256：`ed036f033dc00ae5a867da08176b0cb2685b3e02f5cc7e4dec8610860493e811`；pixel SHA-256：`b073a0664f14d4b63a3eda4fd47b29de24396dd17d52604a98fa723f3d987205`。原截圖副本沒有EXIF／XMP，僅保留ICC色彩描述；像素內容未改變。
